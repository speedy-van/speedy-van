    ...
    <div className="pricing-form max-w-2xl mx-auto p-6 bg-white rounded-lg shadow">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={e =>
            setFormData({ ...formData, distanceMiles: Number(e.target.value) })
          }
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onChange={e =>
            setFormData({ ...formData, helpersCount: Number(e.target.value) })
          }
          className="w-full p-2 border rounded"
        />
      </div>
        ...
        <label className="flex items-center">
          <input
            ...
            onChange={e =>
              setFormData({
                ...formData,
                extras: { ...formData.extras, vat: e.target.checked },
              })
            }
            className="mr-2"
          />
