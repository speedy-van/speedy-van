...
export default function ServiceMapSection() {
  ...
  useEffect(() => {
    const checkMapboxCSS = () => {
      ...
      if (!mapboxCSSLoaded) {
        ...
        link.onerror = () =>
          console.error('Failed to load Mapbox CSS manually');
  ...
  useEffect(() => {
    ...
    const schema = {
      ...
      description:
        'Speedy Van offers premium man and van services across the UK with real-time tracking and neon-dark experience.',
          ...
          try {
            ...
            mapInstance.current.on('load', () => {
              ...
              const cities = [
                ...
                { name: 'Liverpool', lng: -2.58791, lat: 53.408371 },
                { name: 'Sheffield', lng: -1.465541, lat: 53.381129 },
                { name: 'Newcastle', lng: -1.61778, lat: 54.978252 },
                { name: 'Nottingham', lng: -1.149309, lat: 52.954783 },
                { name: 'Bristol', lng: -2.58791, lat: 51.454513 },
                { name: 'Cardiff', lng: -3.17909, lat: 51.481583 },
    ...
    >
      <VStack spacing={{ base: 6, md: 8 }} maxW="6xl" mx="auto" px={4}>
        ...
        <Text
          ...
          lineHeight="tall"
        >
          Speedy Van operates across major UK cities including London,
          Manchester, Birmingham, Glasgow, Edinburgh, Leeds, Liverpool,
          Sheffield, Newcastle, Nottingham, Bristol, Cardiff, and beyond —
          ensuring you can move fast, move right, and stay in control wherever
          you are.
        </Text>
        ...
        <Text
          ...
          lineHeight="tall"
        >
          From the bustling streets of London to the historic lanes of
          Edinburgh, Speedy Van's network covers over 95% of the UK population
          with same-day and next-day delivery options available.
        </Text>
      </VStack>
          ...
          <ModalBody pb={6}>
            <VStack spacing={4} align="stretch">
              <Text color="text.secondary" fontSize="sm">
                Speedy Van operates in these major UK cities and surrounding
                areas:
              </Text>
              ...
              <Text
                ...
                mt={4}
              >
                Don't see your city? Contact us to check availability in your
                area.
              </Text>
            </VStack>
          </ModalBody>
