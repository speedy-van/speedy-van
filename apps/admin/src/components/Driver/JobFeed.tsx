        ...
        <Box flex="1">
          ...
          <AlertDescription>
            ...
            {blockingReason === 'expired_documents' && (
              <Text mt={2}>
                Please renew your expired documents to continue.
              </Text>
            )}
                ...
                <VStack align="stretch" spacing={3}>
                  ...
                  >
                    ...
                    <VStack align="start" spacing={2}>
                      ...
                      <Text fontSize="sm" color="gray.700" pl={6}>
                        {job.vanSize || 'Not specified'}{' '}
                        {job.crewSize && `• ${job.crewSize} crew`}
                      </Text>
                      ...
                      {job.distanceMeters && job.durationSeconds && (
                        <>
                          ...
                          <Text fontSize="sm" color="gray.700" pl={6}>
                            {Math.round(job.distanceMeters / 1000)} km •{' '}
              ...
              <VStack align="stretch" spacing={4}>
                ...
                <Grid templateColumns="repeat(2, 1fr)" gap={4}>
                  ...
                  <Box>
                    ...
                    <Text color="gray.700">
                      {selectedJob.vanSize || 'Not specified'}
                    </Text>
                  </Box>
                  <Box>
                    <Text fontWeight="bold" mb={1}>
                    ...
                    <Text color="gray.700">
                      {selectedJob.crewSize || 'Not specified'}
                    </Text>
                  </Box>
                </Grid>
