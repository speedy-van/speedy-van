  ...
  return (
    <MotionBox
      ...
      _hover={{
        ...
        boxShadow:
          '0 0 0 2px rgba(251, 146, 60, 0.35), 0 8px 24px rgba(0,0,0,.18)',
      }}
      overflow="hidden"
      sx={{
        '&::before': {
          ...
          padding: '2px',
          background:
            'linear-gradient(135deg, rgba(253, 186, 116,.9), rgba(251, 146, 60,.9), rgba(234, 88, 12,.9))',
          WebkitMask:
    ...
    >
      ...
      {isNewlyAdded && (
        <Box
          ...
          inset={0}
          borderRadius="xl"
          boxShadow="0 0 32px rgba(251, 146, 60, .55)"
          pointerEvents="none"
          zIndex={1}
        />
      )}
      ...
      <Box p={4}>
        ...
        >
          ...
          <Text as="span" minW="20px" fontWeight="semibold">
            {quantity}
          </Text>
          <Button
            size="xs"
