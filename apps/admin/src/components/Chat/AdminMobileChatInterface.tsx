      ...
      <div className="mobile-chat-container">
        ...
        <div className="mobile-chat-header">
          ...
          <div className="mobile-chat-header-info">
            <div className="mobile-chat-header-title">Customer Support</div>
                      ...
                      style={{
                        ...
                        background:
                          session.status === 'active'
                            ? 'var(--mobile-chat-primary)'
                            : session.status === 'pending'
                              ? 'var(--mobile-chat-warning)'
                              : 'var(--mobile-chat-success)',
                        color: 'white',
                        fontSize: '10px',
                        borderRadius: '10px',
