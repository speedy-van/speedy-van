...
export function DashboardMap({
  ...
  const mockLocations = [
    ...
    { lat: 51.52, lng: -0.1, type: 'dropoff', jobRef: 'ORD-001' },
    { lat: 51.49, lng: -0.15, type: 'pickup', jobRef: 'ORD-002' },
    { lat: 51.51, lng: -0.12, type: 'dropoff', jobRef: 'ORD-002' },
    { lat: 51.53, lng: -0.08, type: 'pickup', jobRef: 'ORD-003' },
    { lat: 51.5, lng: -0.11, type: 'dropoff', jobRef: 'ORD-003' },
  ];
