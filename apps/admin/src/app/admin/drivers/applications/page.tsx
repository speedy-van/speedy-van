...
export default function DriverApplicationsPage() {
  ...
  const handleApplicationAction = async (
    ...
    try {
      const response = await fetch(
        `/api/admin/drivers/applications/${selectedApplication.id}/${action}`,
        {
          method: 'POST',
          headers: {
  ...
  const autoApproveEligible = pendingApplications.filter(
    app => app.autoApproveEligible
  );
      ...
      <VStack spacing={6} align="stretch">
        ...
        <Grid templateColumns="repeat(auto-fit, minmax(200px, 1fr))" gap={4}>
          <Card
            ...
            _hover={{ shadow: 'neon.glow', transform: 'translateY(-2px)' }}
            ...
            <CardBody>
              <Stat>
                ...
                <StatNumber color="green.500">
                  {autoApproveEligible.length}
                </StatNumber>
                <StatHelpText color="text.tertiary">
                  Score ≥ 85, all docs complete
                </StatHelpText>
              </Stat>
            </CardBody>
          </Card>
          ...
          <CardBody>
            <HStack spacing={4}>
              ...
              >
                ...
                <option value="requires_additional_info">
                ...
                <VStack spacing={3} align="stretch">
                  <Flex justify="space-between" align="start">
                    ...
                    <VStack align="end" spacing={1}>
                      ...
                      <Badge
                        colorScheme={
                          application.autoApproveEligible ? 'green' : 'gray'
                        }
                      >
          ...
          >
            <VStack align="start" spacing={2}>
              ...
              <HStack spacing={4}>
                ...
                <Badge
                  colorScheme={
                    selectedApplication?.autoApproveEligible
                      ? 'green'
                      : 'orange'
                  }
                  size="md"
                        ...
                        <VStack align="start" spacing={4}>
                          ...
                          <VStack align="start" spacing={2}>
                            ...
                            <Text>
                              ...
                              {selectedApplication.rightToWorkType}
                            </Text>
                          </VStack>
                        </VStack>
                      </Grid>
                            ...
                            <CardBody>
                              <VStack spacing={3}>
                                ...
                                <Text fontSize="lg" fontWeight="bold">
                                  {parseInt(
                                    selectedApplication.experience.split(' ')[0]
                                  )}{' '}
                                  years
                                </Text>
                                <Text fontSize="sm" color="text.secondary">
                          ...
                          >
                            <CardBody>
                              <VStack spacing={3}>
                                ...
                                <Text fontSize="sm" color="text.secondary">
                                  {selectedApplication.rating >= 4.8
                                    ? 'Excellent'
                                    : selectedApplication.rating >= 4.5
                                      ? 'Good'
                                      : 'Average'}
                                </Text>
                              </VStack>
                              ...
                              <CardBody>
                                <VStack spacing={4} align="stretch">
                                  <HStack justify="space-between">
                                    ...
                                    <Badge
                                      colorScheme={getDocumentStatusColor(
                                        doc.status
                                      )}
                                    >
                                      {doc.status}
                    ...
                    <VStack spacing={6} align="stretch">
                      ...
                      <Grid templateColumns="1fr 1fr" gap={6}>
                        <VStack align="start" spacing={4}>
                          <Text>
                            <strong>Type:</strong>{' '}
                            {selectedApplication.vehicle.type}
                          </Text>
                          <Text>
                            <strong>Make:</strong>{' '}
                          ...
                          <Text>
                            ...
                            {selectedApplication.vehicle.reg}
                          </Text>
                        </VStack>
                        ...
                        <VStack align="start" spacing={4}>
                          ...
                          <VStack align="start" spacing={2}>
                            ...
                            <HStack>
                              <Icon as={FiCalendar} />
                              <Text>
                                Registration: {selectedApplication.vehicle.reg}
                              </Text>
                            </HStack>
                            <HStack>
                              <Icon as={FiShield} />
                      ...
                      {selectedApplication.complianceIssues.length > 0 ? (
                        <Alert status="error">
                          ...
                          <VStack align="start" spacing={1}>
                            ...
                            <AlertDescription>
                              <VStack align="start" spacing={1}>
                                {selectedApplication.complianceIssues.map(
                                  (issue, index) => (
                        ...
                        >
                          <CardBody>
                            <VStack spacing={3}>
                              ...
                              <Badge
                                colorScheme={
                                  selectedApplication.documents.insurance
                                    .status === 'complete'
                                    ? 'green'
                                    : 'red'
                                }
            ...
            <VStack spacing={4} align="stretch" w="full">
              ...
              <HStack spacing={3} justify="flex-end">
                <Button
                  ...
                  colorScheme="green"
                  onClick={() =>
                    handleApplicationAction('approve', approvalReason)
                  }
                ...
                <Button
                  ...
                  colorScheme="red"
                  onClick={() =>
                    handleApplicationAction('reject', approvalReason)
                  }
                  isLoading={processing}
                  variant="solid"
                ...
                <Button
                  ...
                  colorScheme="orange"
                  onClick={() =>
                    handleApplicationAction('request_info', approvalReason)
                  }
                  isLoading={processing}
                  variant="solid"
