      ...
      if (response.ok) {
        ...
        if (result.success) {
          ...
          toast({
            ...
            description:
              result.message ||
              'This job has already been claimed by another driver',
            status: 'warning',
            duration: 5000,
            isClosable: true,
          });
    ...
    <Box p={6}>
      <VStack spacing={6} align="stretch">
        <Box>
          ...
          <Text color="gray.600">
            Jobs near your location that match your vehicle and preferences
          </Text>
        </Box>
        ...
        {jobs.length === 0 ? (
          <Alert status="info">
            ...
            <Box>
              ...
              <AlertDescription>
                There are currently no jobs available in your area. Try
