...
export default function AvailabilityWindows({
  ...
  const [availabilityWindows, setAvailabilityWindows] =
    useState<AvailabilityWindow[]>(windows);
  const [editingWindow, setEditingWindow] = useState<AvailabilityWindow | null>(
    null
  );
  ...
  const deleteWindow = (windowId: string) => {
    const updatedWindows = availabilityWindows.filter(
        ...
        {availabilityWindows.length > 0 && (
          <Alert status="info">
            ...
            <Box>
              ...
              <AlertDescription>
                These windows will be used to automatically schedule recurring
                shifts and help with job matching.
              </AlertDescription>
            </Box>
          </Alert>
        )}
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="lg">
        ...
        <ModalContent>
          ...
          <ModalFooter>
            ...
            <Button colorScheme="blue" onClick={saveWindow}>
