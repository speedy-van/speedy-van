...
export default function ActiveJobHandler({
  onJobCompleted,
}: ActiveJobHandlerProps) {
  ...
  const handleCompleteStep = async () => {
    ...
    if (config.requiresMedia && mediaUrls.length === 0) {
      toast({
        ...
        description:
          (config as any).mediaDescription || 'Please add photos for this step',
        status: 'warning',
        duration: 3000,
        isClosable: true,
      });
          ...
          <VStack align="stretch" spacing={6}>
            ...
            <HStack justify="space-between">
              <VStack align="start" spacing={1}>
                <Heading size="md">
                  Active Job #{activeJob.job.reference}
                </Heading>
              ...
              {activeJob.stepOrder.map((step, index) => {
                ...
                return (
                  <Button
                    ...
                    variant={
                      isCompleted ? 'solid' : isCurrent ? 'solid' : 'outline'
                    }
                ...
                stepConfig[selectedStep as keyof typeof stepConfig]
                  ...
                  <Box>
                    <Text fontWeight="medium" mb={3}>
                      {(
                        stepConfig[
                          selectedStep as keyof typeof stepConfig
                        ] as any
