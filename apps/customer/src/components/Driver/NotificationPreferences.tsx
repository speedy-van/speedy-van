    ...
    <Box>
      <VStack spacing={6} align="stretch">
        <Box>
          ...
          <Text color="gray.600">
            Choose how you want to receive notifications about jobs, messages,
            and updates.
          </Text>
        </Box>
            ...
            <FormControl>
              <HStack justify="space-between">
                <Box>
                  ...
                  <FormHelperText>
                    Updates about your active jobs
                  </FormHelperText>
                </Box>
                <Switch
            ...
            <FormControl>
              <HStack justify="space-between">
                <Box>
                  ...
                  <FormHelperText>
                    New messages from customers or support
                  </FormHelperText>
                </Box>
                <Switch
            ...
            <FormControl>
              <HStack justify="space-between">
                <Box>
                  ...
                  <FormHelperText>
                    Changes to your scheduled jobs
                  </FormHelperText>
                </Box>
                <Switch
            ...
            <FormControl>
              <HStack justify="space-between">
                <Box>
                  ...
                  <FormHelperText>
                    Payout confirmations and issues
                  </FormHelperText>
                </Box>
                <Switch
            ...
            <FormControl>
              <HStack justify="space-between">
                <Box>
                  <FormLabel mb={1}>Payout Events</FormLabel>
                  <FormHelperText>
                    Email confirmations for payouts
                  </FormHelperText>
                </Box>
                <Switch
            ...
            <FormControl>
              <HStack justify="space-between">
                <Box>
                  <FormLabel mb={1}>System Alerts</FormLabel>
                  <FormHelperText>
                    Important system updates via email
                  </FormHelperText>
                </Box>
                <Switch
        ...
        <Box>
          ...
          <Text color="gray.600" mb={4}>
            SMS notifications are currently disabled. This feature will be
            available soon.
          </Text>
            ...
            <FormControl isDisabled>
              <HStack justify="space-between">
                <Box>
                  <FormLabel mb={1}>System Alerts</FormLabel>
                  <FormHelperText>
                    Important system updates via SMS
                  </FormHelperText>
                </Box>
                <Switch isChecked={false} />
              </HStack>
