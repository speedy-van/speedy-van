...
export default function NavigationPanel({
  ...
  const [navigationUrls, setNavigationUrls] = useState<NavigationUrls | null>(
    null
  );
  ...
  const openNavigation = (
    type: 'pickup' | 'dropoff',
    provider: 'google' | 'apple' | 'universal' = 'universal'
  ) => {
            ...
            <Box>
              ...
              <VStack spacing={2} align="stretch">
                {isNavigatingToPickup && (
                  <HStack justify="space-between">
                    ...
                    <Text fontSize="sm" fontWeight="medium">
                      {Math.round(routeInfo.distanceToPickup / 1000)}km •{' '}
                      {routeInfo.etaToPickupMinutes}min
                    </Text>
                  </HStack>
                )}
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm" fontWeight="medium">
                    {Math.round(routeInfo.totalDistance / 1000)}km •{' '}
              ...
              <HStack spacing={2} justify="center">
                <Tooltip label="Open in Google Maps">
                  <IconButton
                    ...
                    onClick={() =>
                      openNavigation(
                        isNavigatingToPickup ? 'pickup' : 'dropoff',
                        'google'
                      )
                    }
