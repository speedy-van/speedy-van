        ...
        <Alert status="warning" size="sm" mt={2}>
          ...
          <Box>
            ...
            <AlertDescription>
              ...
              {metric.unit}) exceeds threshold ({metric.threshold}
              {metric.unit})
            </AlertDescription>
          </Box>
        </Alert>
          ...
          <Card>
            <CardHeader>
              <Stat>
                ...
                <StatNumber>
                  {metrics.find(m => m.name === 'customer_portal_load_time')
                    ?.value || 0}
                  ms
                </StatNumber>
                <StatHelpText>
          ...
          <Card>
            <CardHeader>
              <Stat>
                ...
                <StatNumber>
                  {metrics.find(m => m.name === 'time_to_first_content')
                    ?.value || 0}
                  ms
                </StatNumber>
                <StatHelpText>
          ...
          <Card>
            <CardHeader>
              <Stat>
                ...
                <StatNumber>
                  {metrics.find(m => m.name === 'auth_sign_in_success_rate')
                    ?.value || 0}
                  %
                </StatNumber>
                <StatHelpText>
