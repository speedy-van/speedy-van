...
export default function ConfirmationStep({
  ...
  const downloadInvoice = async () => {
    try {
      ...
      pdf.setFont('helvetica', 'normal');
      pdf.text(
        `Move Date: ${bookingData.date ? new Date(bookingData.date).toLocaleDateString('en-GB') : 'N/A'}`,
        20,
        currentY
      );
      currentY += 6;
      ...
      if (bookingData.pickupAddress) {
        pdf.text(
          `Pickup: ${bookingData.pickupAddress.line1 || ''}, ${bookingData.pickupAddress.city || ''}`,
          20,
          currentY
        );
        currentY += 6;
      ...
      if (bookingData.dropoffAddress) {
        pdf.text(
          `Dropoff: ${bookingData.dropoffAddress.line1 || ''}, ${bookingData.dropoffAddress.city || ''}`,
          20,
          currentY
        );
        currentY += 6;
      ...
      pdf.text(
        `£${(bookingData.calculatedTotal || 0).toFixed(2)}`,
        160,
        currentY + 3
      );
      ...
      pdf.setFont('helvetica', 'normal');
      pdf.text(
        'Thank you for choosing Speedy Van for your moving needs!',
        20,
        currentY
      );
      currentY += 6;
      pdf.text(
        'For any questions, please contact us at support@speedy-van.co.uk or call 07901846297',
        20,
        currentY
      );
      currentY += 6;
      pdf.text(
        'This invoice is automatically generated and valid without signature.',
        20,
        currentY
      );
      ...
      toast({
        ...
        description:
          'Your professional invoice has been downloaded successfully.',
        status: 'success',
        duration: 3000,
        isClosable: true,
      });
      ...
      toast({
        ...
        description:
          'There was an issue generating your invoice. Please try again.',
        status: 'error',
        duration: 3000,
        isClosable: true,
      });
      ...
      >
        <VStack spacing={6} align="center" py={8}>
          ...
          <Text fontSize="sm" color="text.secondary" textAlign="center">
            Please wait while we verify your payment and process your booking
            confirmation.
          </Text>
          ...
          >
            <HStack justify="center" spacing={2}>
              ...
              <Text fontSize="sm" color="green.700" fontWeight="medium">
                Payment Confirmed - £
                {formatCurrency(bookingData.calculatedTotal || 0)}
              </Text>
            </HStack>
          </Box>
        </Box>
        ...
        >
          ...
          <VStack align="start" spacing={3}>
            ...
            <HStack>
              ...
              <Text>
                We'll send you the driver's contact details 24 hours before your
                move
              </Text>
            </HStack>
            <HStack>
        ...
        >
          ...
          <VStack align="start" spacing={3}>
            <HStack>
              ...
              <Link href="tel:07901846297" color="neon.500">
                07901846297
              </Link>
            </HStack>
            <HStack>
              ...
              <Link href="mailto:support@speedy-van.co.uk" color="neon.500">
        ...
        >
          ...
          <VStack align="start" spacing={2}>
            <HStack>
              ...
              <Text fontSize="sm">
                Includes detailed item breakdown and pricing
              </Text>
            </HStack>
            <HStack>
              <Icon as={FaCheckCircle} color="brand.500" boxSize={4} />
