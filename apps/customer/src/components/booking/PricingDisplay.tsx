...
export default function PricingDisplay({
  ...
  const convertToPricingInputs = useCallback(
    (data: any): PricingInputs | null => {
      try {
        ...
        return {
          ...
          pickupHasLift:
            data.pickupHasLift || data.pickupProperty?.hasLift || false,
          dropoffFloors: data.dropoffFloors || data.dropoffProperty?.floor || 0,
          dropoffHasLift:
            data.dropoffHasLift || data.dropoffProperty?.hasLift || false,
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      ...
      try {
        ...
        if (onPriceChange) {
          console.log(
            'PricingDisplay - calling onPriceChange with:',
            ...
            >
              ...
              <VStack spacing={3} align="stretch">
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm">
                    £{quote.breakdown?.distanceBase?.toFixed(2) || '0.00'}
                  </Text>
                </HStack>
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm">
                    £{quote.breakdown?.totalVolumeFactor?.toFixed(2) || '0.00'}
                  </Text>
                </HStack>
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm">
                    £{quote.breakdown?.floorsCost?.toFixed(2) || '0.00'}
                  </Text>
                </HStack>
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm">
                    £{quote.breakdown?.helpersCost?.toFixed(2) || '0.00'}
                  </Text>
                </HStack>
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm">
                    £{quote.breakdown?.extrasCost?.toFixed(2) || '0.00'}
                  </Text>
                </HStack>
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm">
                    £{quote.breakdown?.vat?.toFixed(2) || '0.00'}
                  </Text>
                </HStack>
                ...
                <HStack justify="space-between">
                  <Text fontSize="sm" fontWeight="bold" color="neon.500">
                    Total
                  </Text>
                  <Text fontSize="sm" fontWeight="bold" color="neon.500">
                    £{quote.breakdown?.total?.toFixed(2) || '0.00'}
              ...
              >
                <HStack spacing={2}>
                  ...
                  <Text fontSize="sm" color="text.secondary">
                    This is an estimated price. Final price may vary based on
                    actual requirements.
                  </Text>
                </HStack>
              </Box>
