...
const PROPERTY_TYPES = [
  {
    ...
    icon: FaBuilding,
    color: 'blue.500',
    description: 'Residential apartment or flat',
  },
  {
    value: 'HOUSE',
    label: 'House',
  ...
  },
  {
    ...
    icon: FaStore,
    color: 'pink.500',
    description: 'Retail or commercial space',
  },
  {
    value: 'OTHER',
    label: 'Other',
      ...
      <VStack spacing={8} align="stretch">
        ...
        <Box textAlign="center">
          ...
          <Text
            ...
            mx="auto"
          >
            Tell us about the properties for pickup and delivery to ensure
            smooth service
          </Text>
        </Box>
        ...
        <Box
          ...
          _before={{
            ...
            borderRadius: 'xl',
            background:
              'linear-gradient(135deg, rgba(0,194,255,0.08), rgba(0,209,143,0.08))',
            pointerEvents: 'none',
          }}
        >
          <HStack spacing={4} position="relative" zIndex={1}>
            ...
            <Box flex="1">
              ...
              <Text color="text.primary" fontSize="sm" lineHeight="1.6">
                Please ensure your floor number is correct as our drivers will
                deliver your items to the specified floor. Use{' '}
                <Badge colorScheme="neon" variant="solid" size="sm">
                  0
                </Badge>{' '}
                for ground floor,
                <Badge colorScheme="neon" variant="solid" size="sm">
              ...
              <SimpleGrid columns={{ base: 2, md: 3 }} spacing={4}>
                {PROPERTY_TYPES.map(type => (
                  <Box
                    ...
                    onClick={() =>
                      updatePickupProperty('propertyType', type.value)
                    }
                    position="relative"
                    overflow="hidden"
                    textAlign="center"
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} w="full">
              <FormControl isInvalid={!!errors.pickupFloor}>
                ...
                <NumberInput
                  ...
                  value={
                    bookingData.pickupProperty?.floor !== undefined
                      ? bookingData.pickupProperty.floor
                      : ''
                  }
                  onChange={value => {
                    const numValue = parseInt(value);
                    updatePickupProperty(
                      'floor',
              ...
              <FormControl>
                ...
                >
                  <Checkbox
                    ...
                    onChange={e =>
                      updatePickupProperty('hasLift', e.target.checked)
                    }
                    size="lg"
                    colorScheme="brand"
                  >
              ...
              <SimpleGrid columns={{ base: 2, md: 3 }} spacing={4}>
                {PROPERTY_TYPES.map(type => (
                  <Box
                    ...
                    onClick={() =>
                      updateDropoffProperty('propertyType', type.value)
                    }
                    position="relative"
                    overflow="hidden"
                    textAlign="center"
                  >
                    ...
                    {bookingData.dropoffProperty?.propertyType ===
                      ...
                      <Box
                        ...
                        width="100%"
                        height="100%"
                        bg="linear-gradient(135deg, rgba(0,194,255,0.1), rgba(0,194,255,0.1))"
                        borderRadius="xl"
                        zIndex={0}
                      />
                    )}
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} w="full">
              <FormControl isInvalid={!!errors.dropoffFloor}>
                ...
                <NumberInput
                  ...
                  value={
                    bookingData.dropoffProperty?.floor !== undefined
                      ? bookingData.dropoffProperty.floor
                      : ''
                  }
                  onChange={value => {
                    const numValue = parseInt(value);
                    updateDropoffProperty(
                      'floor',
                      isNaN(numValue) ? undefined : numValue
                    );
                  }}
              ...
              <FormControl>
                ...
                >
                  <Checkbox
                    ...
                    onChange={e =>
                      updateDropoffProperty('hasLift', e.target.checked)
                    }
                    size="lg"
                    colorScheme="neon"
                  >
