      ...
      <Card>
        <CardBody>
          <Tabs variant="enclosed">
            <TabList>
              <Tab>Current & Upcoming ({currentUpcoming.length})</Tab>
              <Tab>Past ({past.length})</Tab>
              <Tab>All ({all.length})</Tab>
            </TabList>
            <TabPanels>
              <TabPanel>{renderTable(currentUpcoming)}</TabPanel>
              <TabPanel>{renderTable(past)}</TabPanel>
              <TabPanel>{renderTable(all)}</TabPanel>
            </TabPanels>
          </Tabs>
        </CardBody>
      </Card>
