...
const STATUS_TIMELINE = [
  ...
  },
  {
    status: 'assigned',
    label: 'Crew Assigned',
    description: 'Your crew has been assigned',
  },
  {
    status: 'en_route_pickup',
    label: 'En Route to Pickup',
    description: 'Your crew is on the way to pickup',
  },
  {
    status: 'arrived',
...
export default function OrderDetails() {
  ...
  const handleCancelOrder = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/customer/orders/${booking.code}/cancel`,
        {
          method: 'POST',
          headers: {
  ...
  if (error || !booking) {
    return (
      <Box textAlign="center" py={8}>
        ...
        <Button
          onClick={() => fetchBooking(params.code as string)}
          colorScheme="blue"
        >
          Try Again
        </Button>
  ...
  const canReschedule = ['open', 'pending_dispatch', 'confirmed'].includes(
    booking.status
  );
  const canCancel = ['open', 'pending_dispatch', 'confirmed'].includes(
    booking.status
  );
  const canTrack = [
    'assigned',
    ...
    <Stack spacing={6}>
      ...
      <VStack align="start" spacing={4}>
        ...
        <HStack spacing={3} flexWrap="wrap">
          ...
          <Badge
            size="lg"
            colorScheme={booking.paymentStatus === 'paid' ? 'green' : 'yellow'}
          >
              ...
              >
                <VStack>
                  ...
                  <Text fontSize="sm" color="gray.500">
                    Click "Open Full Map" to view real-time location
                  </Text>
                </VStack>
              </Box>
            </Box>
            ...
            <VStack align="stretch" spacing={4}>
              <HStack justify="space-between">
                ...
                <Text fontWeight="bold" fontSize="lg">
                  {booking.amountPence
                    ? formatCurrency(booking.amountPence)
                    : '—'}
                </Text>
              </HStack>
            ...
            <VStack spacing={4} textAlign="center">
              ...
              >
                ...
                <Text fontSize="sm" color="red.600">
                  ...
                  cancellation fee depending on your booking terms.
                </Text>
              </Box>
