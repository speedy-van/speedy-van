...
export default async function CustomerPortalHome() {
  ...
  const [nextBooking, recentOrders, outstandingPayments, invoiceStats] =
    await Promise.all([
  ...
  return (
    <VStack align="stretch" spacing={6} as="main">
      ...
      <Box as="section" aria-labelledby="welcome-heading">
        <Heading id="welcome-heading" size="lg" mb={2}>
          Hello, {firstName}!
        </Heading>
        ...
        <Card as="section" aria-labelledby="next-booking-heading">
          <CardHeader>
            <HStack justify="space-between">
              <Heading id="next-booking-heading" size="md">
                Next Booking
              </Heading>
              <Badge
              ...
              <Box>
                ...
                <Text fontSize="sm" color="text.muted">
                  {nextBooking.scheduledAt
                    ...
                    : 'Date TBD'}{' '}
                  at{' '}
                  {nextBooking.estimatedDurationMinutes
                    ? `${nextBooking.estimatedDurationMinutes} minutes`
                    : 'Time TBD'}
                </Text>
              </Box>
      ...
      <Box as="section" aria-labelledby="quick-actions-heading">
        <Heading id="quick-actions-heading" size="md" mb={4}>
          Quick Actions
        </Heading>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={4}>
          ...
          >
            <VStack spacing={2}>
              <Text fontSize="2xl" role="img" aria-hidden="true">
                📦
              </Text>
      ...
      <Box as="section" aria-labelledby="recent-orders-heading">
        <HStack justify="space-between" mb={4}>
          <Heading id="recent-orders-heading" size="md">
            Recent Orders
          </Heading>
          <Button
            as={NextLink as any}
      ...
      <Box as="section" aria-labelledby="invoice-summary-heading">
        <HStack justify="space-between" mb={4}>
          <Heading id="invoice-summary-heading" size="md">
            Invoice Summary
          </Heading>
          <Button
            as={NextLink as any}
      ...
      {outstandingPayments.length > 0 && (
        <Box as="section" aria-labelledby="outstanding-actions-heading">
          <Heading id="outstanding-actions-heading" size="md" mb={4}>
            Outstanding Actions
          </Heading>
          <VStack align="stretch" spacing={3}>
      ...
      >
        <CardBody>
          <Heading id="announcements-heading" size="sm" mb={2}>
            <Text as="span" role="img" aria-hidden="true">
              📢
            </Text>{' '}
            Service Updates
          </Heading>
