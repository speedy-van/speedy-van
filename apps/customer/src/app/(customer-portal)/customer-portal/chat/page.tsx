...
export default function CustomerChatPage() {
  ...
  const [enableAI, setEnableAI] = useState(true); // تفعيل AI Agent افتراضياً
                ...
                <VStack spacing={3} align="stretch">
                  ...
                  <HStack justify="space-between" p={2} bg="gray.50" borderRadius="md">
                    <HStack spacing={2}>
                      ...
                      <Badge colorScheme={enableAI ? 'green' : 'gray'} variant="subtle">
                        {enableAI ? 'مفعل' : 'معطل'}
                      </Badge>
                    </HStack>
                    <Button
                      size="xs"
                      variant={enableAI ? 'solid' : 'outline'}
                      colorScheme={enableAI ? 'green' : 'gray'}
                      onClick={() => setEnableAI(!enableAI)}
                    >
                      {enableAI ? 'إلغاء' : 'تفعيل'}
                    </Button>
                  </HStack>
                </VStack>
              </Box>
