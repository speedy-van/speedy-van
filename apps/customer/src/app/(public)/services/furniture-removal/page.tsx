...
export const metadata: Metadata = {
  title:
    'Furniture Removal Service | Professional Furniture Delivery | Speedy Van',
  description:
    'Professional furniture removal and delivery service across the UK. Safe transport for all furniture types from £35/hour. Assembly service available. Book online now.',
  keywords:
    'furniture removal, furniture delivery, furniture transport, sofa delivery, bed delivery, furniture moving service, professional furniture movers',
  alternates: {
    canonical: 'https://speedy-van.co.uk/services/furniture-removal',
  },
  openGraph: {
    title:
      'Furniture Removal Service | Professional Furniture Delivery | Speedy Van',
    description:
      'Professional furniture removal and delivery from £35/hour. Safe transport, assembly service, fully insured. Book your furniture move online.',
    url: 'https://speedy-van.co.uk/services/furniture-removal',
    siteName: 'Speedy Van',
    images: [
      {
        url: '/og/og-furniture-removal.jpg',
        width: 1200,
        height: 630,
...
const furnitureTypes = [
  {
    ...
    title: 'Sofas & Seating',
    description:
      'Professional sofa delivery and removal with protective covering',
    items: [
      '3-seater sofas',
      'Corner sofas',
      'Recliners',
...
const specialtyServices = [
  {
    title: 'Piano Removal',
    description:
      'Specialized piano moving with expert equipment and techniques',
  },
  {
...
const protectionMethods = [
  {
    ...
    description:
      'All furniture wrapped in protective blankets and plastic covering',
  },
  {
      ...
      <Container maxW="7xl" py={16}>
        ...
        <VStack spacing={8} textAlign="center" mb={16}>
          ...
          <Text fontSize="xl" color="gray.600" maxW="4xl">
            Expert furniture removal and delivery service across the UK. From
            single items to complete room sets, we handle your furniture with
            professional care. Assembly service available from £35/hour.
          </Text>
        ...
        <VStack spacing={12} mt={16}>
          ...
          <Text textAlign="center" color="gray.600" maxW="2xl">
            Transparent pricing based on your furniture removal needs. All
            prices include professional team, protective materials, and basic
            assembly service.
          </Text>
        ...
        <VStack spacing={8} mt={16}>
          ...
          <Text textAlign="center" color="gray.600" maxW="2xl">
            We handle all types of furniture with specialized techniques and
            equipment for different items.
          </Text>
        ...
        <VStack spacing={12} mt={16}>
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8} w="full">
            <VStack spacing={4} textAlign="center">
              ...
              <Text color="gray.600">
                We assess your furniture and determine the best protection and
                transport method.
              </Text>
            </VStack>
            ...
            <VStack spacing={4} textAlign="center">
              ...
              <Text color="gray.600">
                Your furniture is carefully wrapped and protected using
            ...
            <VStack spacing={4} textAlign="center">
              ...
              <Text color="gray.600">
                Safe transport and careful placement at your destination with
                assembly if needed.
              </Text>
            </VStack>
          </SimpleGrid>
          ...
          >
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <VStack spacing={4} align="start">
                ...
                <Text color="gray.700">
                  "Excellent furniture delivery service! They moved our entire
                  living room set with such care. Not a single scratch on
                  anything. Highly professional team."
                </Text>
            ...
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <VStack spacing={4} align="start">
                ...
                <Text color="gray.700">
                  "Amazing service for our antique furniture. They took extra
                  care and everything arrived in perfect condition. The assembly
                  service was a bonus!"
                </Text>
                <Text fontWeight="bold" color="gray.800">
                  - David M., Edinburgh
        ...
        <Box mt={16} textAlign="center" bg="blue.50" p={12} borderRadius="xl">
          <VStack spacing={6}>
            ...
            <Text fontSize="lg" color="gray.600" maxW="2xl">
              Trust the experts with your valuable furniture. Professional
              service, competitive prices, and complete peace of mind. Book your
            ...
            __html: JSON.stringify(
              {
                ...
                description:
                  'Professional furniture removal and delivery service with assembly options',
                url: 'https://speedy-van.co.uk/services/furniture-removal',
                provider: {
                  '@type': 'Organization',
