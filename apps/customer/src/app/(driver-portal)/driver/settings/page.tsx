      ...
      if (response.ok) {
        ...
        if (data.vehicle) {
          setVehicleInfo({
            ...
            motExpiry: data.vehicle.motExpiry
              ? new Date(data.vehicle.motExpiry).toISOString().split('T')[0]
              : '',
          });
        }
        ...
        if (data.checks) {
          setLicenseInfo({
            ...
            licenceExpiry: data.checks.licenceExpiry
              ? new Date(data.checks.licenceExpiry).toISOString().split('T')[0]
              : '',
          });
          ...
          setInsuranceInfo({
            ...
            policyStart: data.checks.policyStart
              ? new Date(data.checks.policyStart).toISOString().split('T')[0]
              : '',
            policyEnd: data.checks.policyEnd
              ? new Date(data.checks.policyEnd).toISOString().split('T')[0]
              : '',
          });
          ...
          setRtwInfo({
            ...
            rtwExpiresAt: data.checks.rtwExpiresAt
              ? new Date(data.checks.rtwExpiresAt).toISOString().split('T')[0]
              : '',
          });
          ...
          setDbsInfo({
            ...
            dbsCheckedAt: data.checks.dbsCheckedAt
              ? new Date(data.checks.dbsCheckedAt).toISOString().split('T')[0]
              : '',
            dbsRetentionUntil: data.checks.dbsRetentionUntil
              ? new Date(data.checks.dbsRetentionUntil)
                  .toISOString()
                  .split('T')[0]
              : '',
          });
      ...
      {profileData && (
        <Alert status="info" mb={6}>
          ...
          <Box>
            ...
            <AlertDescription>
              Your current status:{' '}
              {getStatusBadge(profileData.profile.onboardingStatus)}
        ...
        <Alert status="warning" mb={6}>
          ...
          <Box>
            ...
            <AlertDescription>
              ...
              {new Date(
                deletionRequest.deletionRequest!.scheduledFor
              ).toLocaleDateString()}
              .
                ...
                <CardBody>
                  <VStack spacing={4} align="stretch">
                    <HStack justify="space-between">
                      ...
                      <Badge
                        colorScheme={twoFactorData?.enabled ? 'green' : 'gray'}
                      >
              ...
              <Card>
                <CardBody>
                  <VStack spacing={4} align="stretch">
                    ...
                    <Text color="gray.600">Change your account password</Text>
                  ...
                  <VStack spacing={4} align="stretch">
                    <HStack justify="space-between">
                      ...
                      <Switch
                        ...
                        onChange={e =>
                          handleLocationConsentChange(e.target.checked)
                        }
                        colorScheme="blue"
                      />
                    </HStack>
                    <Alert status="info">
                      <AlertIcon />
                      <Text>
                        Location sharing helps us match you with nearby jobs and
                        provide accurate ETAs to customers. Your location is
                        only shared when you're online and actively looking for
                        work.
                      </Text>
                    </Alert>
                  </VStack>
                ...
                <CardBody>
                  <VStack spacing={4} align="stretch">
                    ...
                    <Alert status="info">
                      <AlertIcon />
                      <Text>
                        You can request a copy of all your personal data stored
                        in our system. The export will include your profile, job
                        history, earnings, and other account information.
                      </Text>
                    </Alert>
                  </VStack>
                </CardBody>
                  ...
                  <VStack spacing={4} align="stretch">
                    ...
                    <Alert status="warning">
                      ...
                      <Text>
                        ...
                        permanently deleted after 30 days. You can cancel the
                        deletion request at any time during this period.
                      </Text>
                    </Alert>
                  </VStack>
                </CardBody>
                  ...
                  <Grid templateColumns="repeat(2, 1fr)" gap={4}>
                    <GridItem>
                      <FormControl>
                        ...
                        <Stack spacing={2}>
                          {['B', 'B+E', 'C1', 'C1+E', 'C', 'C+E'].map(
                            category => (
                              <Checkbox
                                key={category}
                                isChecked={licenseInfo.licenceCategories.includes(
                                  category
                                )}
                                onChange={e => {
                                  const newCategories = e.target.checked
                                    ? [
                                        ...licenseInfo.licenceCategories,
                                        category,
                                      ]
                                    : licenseInfo.licenceCategories.filter(
                                        c => c !== category
                                      );
                                  setLicenseInfo({
                                    ...licenseInfo,
                                    licenceCategories: newCategories,
                                  });
                                }}
                              >
                                Category {category}
                  ...
                  <Stack spacing={4}>
                    <Checkbox
                      ...
                      onChange={e =>
                        setInsuranceInfo({
                          ...insuranceInfo,
                          goodsInTransit: e.target.checked,
                        })
                      }
                    >
                    ...
                    <Checkbox
                      ...
                      onChange={e =>
                        setInsuranceInfo({
                          ...insuranceInfo,
                          publicLiability: e.target.checked,
                        })
                      }
                    >
                ...
                <VStack spacing={4} align="stretch">
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setRtwInfo({ ...rtwInfo, rtwMethod: e.target.value })
                      }
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setRtwInfo({ ...rtwInfo, rtwResultRef: e.target.value })
                      }
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setRtwInfo({ ...rtwInfo, rtwExpiresAt: e.target.value })
                      }
                    />
                  </FormControl>
                  ...
                  <Alert status="info">
                    ...
                    <Box>
                      ...
                      <AlertDescription>
                        You must provide proof of your right to work in the UK.
                        This can be done through document verification or online
                        checks.
                      </AlertDescription>
                    </Box>
                  </Alert>
                ...
                <VStack spacing={4} align="stretch">
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setDbsInfo({ ...dbsInfo, dbsType: e.target.value })
                      }
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setDbsInfo({ ...dbsInfo, dbsCheckRef: e.target.value })
                      }
                      ...
                      <FormControl>
                        ...
                        <Input
                          ...
                          onChange={e =>
                            setDbsInfo({
                              ...dbsInfo,
                              dbsRetentionUntil: e.target.value,
                            })
                          }
                        />
                      </FormControl>
                  ...
                  <Alert status="info">
                    ...
                    <Box>
                      ...
                      <AlertDescription>
                        A Basic DBS check is required for all drivers. This
                        check will be verified by our compliance team.
                      </AlertDescription>
                    </Box>
                  </Alert>
                </VStack>
