...
export default function CookiePreferencesModal() {
  const { consent, setConsent, isPreferencesOpen, closePreferences } =
    useConsent();
    ...
    >
      ...
      <ModalContent
        ...
        _before={{
          ...
          background:
            'radial-gradient(circle at 50% 0%, rgba(0,194,255,0.1) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      >
        <ModalHeader
          ...
          <VStack spacing={{ base: 8, md: 6 }} align="stretch">
            ...
            >
              ...
              <Text fontSize="sm" color="gray.300" lineHeight="1.5">
                ...
                properly. They cannot be disabled and are always active.
              </Text>
            </Box>
            ...
            >
              ...
              <Text fontSize="xs" color="gray.400" lineHeight="1.4">
                ...
                <a
                  href="/legal/cookies"
                  style={{ textDecoration: 'underline', color: '#00C2FF' }}
                >
                  Cookie Policy
                </a>{' '}
                for detailed information about how we use cookies and protect
                your data.
              </Text>
            </Box>
          </VStack>
