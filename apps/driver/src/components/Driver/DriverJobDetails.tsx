            ...
            <CardBody>
              <VStack align="start" spacing={3}>
                <HStack>
                  ...
                  <Text>
                    <strong>Name:</strong> {jobDetails.customer.name}
                  </Text>
                </HStack>
                <HStack>
                  <Icon as={FaPhone} color="gray.500" boxSize={4} />
                  <Text>
                    <strong>Phone:</strong> {jobDetails.customer.phone}
                  </Text>
                </HStack>
            ...
            <CardBody>
              <VStack align="start" spacing={3}>
                <HStack>
                  ...
                  <Text>
                    <strong>Date:</strong>{' '}
                    {new Date(jobDetails.schedule.date).toLocaleDateString(
                      'en-GB'
                    )}
                  </Text>
                </HStack>
                <HStack>
                  ...
                  <Text>
                    <strong>Time:</strong> {jobDetails.schedule.timeSlot}
                  </Text>
                </HStack>
                <HStack>
                  ...
                  <Text>
                    ...
                    {jobDetails.schedule.estimatedDuration} minutes
                  </Text>
                </HStack>
              </VStack>
            </CardBody>
          ...
          >
            <CardHeader>
              <HStack>
                <Icon
                  as={FaUsers}
                  color={getCrewSizeColor(
                    jobDetails.crewRecommendation.suggestedCrewSize
                  )}
                />
                <Heading size="sm">Crew Size Recommendation</Heading>
                <Badge
                  colorScheme={getCrewSizeColor(
                    jobDetails.crewRecommendation.suggestedCrewSize
                  )}
                  variant="solid"
                >
            ...
            <CardBody>
              <VStack align="start" spacing={3}>
                ...
                <Box w="full">
                  ...
                  <List spacing={1}>
                    {jobDetails.crewRecommendation.factors.map(
                      (factor, index) => (
        ...
        <VStack spacing={6} align="stretch">
            ...
            <CardBody>
              <VStack align="start" spacing={3}>
                <Text fontWeight="medium">
                  {jobDetails.addresses.pickup.line1}
                </Text>
                <Text color="gray.600">
                  {jobDetails.addresses.pickup.city},{' '}
                  {jobDetails.addresses.pickup.postcode}
                </Text>
                ...
                <HStack>
                  ...
                  <Text fontSize="sm">
                    ...
                    {jobDetails.properties.pickup.type}
                  </Text>
                </HStack>

                <HStack>
                  <Icon
                    as={getAccessIcon(jobDetails.properties.pickup.access)}
          ...
          <Card>
            ...
            <CardBody>
              <VStack align="start" spacing={3}>
                <Text fontWeight="medium">
                  {jobDetails.addresses.dropoff.line1}
                </Text>
                <Text color="gray.600">
                  {jobDetails.addresses.dropoff.city},{' '}
                  {jobDetails.addresses.dropoff.postcode}
                </Text>
                ...
                <HStack>
                  ...
                  <Text fontSize="sm">
                    <strong>Property:</strong>{' '}
                    {jobDetails.properties.dropoff.type}
                  </Text>
                </HStack>

                <HStack>
                  <Icon
                    as={getAccessIcon(jobDetails.properties.dropoff.access)}
                    color={getAccessColor(jobDetails.properties.dropoff.access)}
                    boxSize={4}
                  />
                  <Text fontSize="sm">
                    <strong>Floor:</strong>{' '}
                    {jobDetails.properties.dropoff.floor}
                    <Text as="span" color="gray.500" ml={2}>
      ...
      <Card mt={6}>
        <CardBody>
          <HStack justify="center" spacing={4}>
            <Button colorScheme="blue" leftIcon={<FaCheckCircle />} size="lg">
              Accept Job
            </Button>
            <Button variant="outline" leftIcon={<FaClock />} size="lg">
              Start Job
            </Button>
            <Button variant="outline" leftIcon={<FaRoute />} size="lg">
              View Route
            </Button>
          </HStack>
        </CardBody>
