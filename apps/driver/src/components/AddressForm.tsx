...
export default function AddressForm({
  ...
  const handleSubmit = () => {
    if (!pickup.line1 || !dropoff.line1) {
      toast({
        title: 'Both pickup and dropoff are required',
        status: 'warning',
      });
      return;
    }
              ...
              <VStack spacing={3} mt={4}>
                <FormControl>
                  ...
                  <Input
                    value={pickup.line1}
                    onChange={e =>
                      setPickup({ ...pickup, line1: e.target.value })
                    }
                ...
                <HStack spacing={4} width="100%">
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setPickup({ ...pickup, postcode: e.target.value })
                      }
                ...
                <Checkbox
                  ...
                  onChange={e =>
                    setPickup({ ...pickup, lift: e.target.checked })
                  }
                >
              ...
              <VStack spacing={3} mt={4}>
                <FormControl>
                  ...
                  <Input
                    value={dropoff.line1}
                    onChange={e =>
                      setDropoff({ ...dropoff, line1: e.target.value })
                    }
                    placeholder="Street address"
                  />
                </FormControl>
                ...
                <HStack spacing={4} width="100%">
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={e =>
                        setDropoff({ ...dropoff, postcode: e.target.value })
                      }
                      placeholder="Postcode"
                    />
                  </FormControl>
                ...
                <Checkbox
                  ...
                  onChange={e =>
                    setDropoff({ ...dropoff, lift: e.target.checked })
                  }
                >
