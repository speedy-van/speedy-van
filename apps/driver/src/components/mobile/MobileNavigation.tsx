...
const MobileHeader: React.FC<{
  ...
  return (
    ...
    >
      <Flex align="center" justify="space-between" px={4} py={3} minH="56px">
        {/* Menu button */}
        <IconButton
                      ...
                      >
                        <VStack align="start" spacing={0} flex={1}>
                          ...
                          <Text
                            fontSize="xs"
                            color={
                              isActive ? 'whiteAlpha.800' : 'text.tertiary'
                            }
                            noOfLines={1}
                          >
                            {item.description}
...
export const MobileNavigation: React.FC<{
  ...
  return (
    <Box minH="100vh" bg="bg.canvas">
      {/* Mobile header */}
      <Box boxShadow={isScrolled ? 'md' : 'none'} transition="box-shadow 0.2s">
      ...
      {/* Page content */}
      <Box pb={{ base: '80px', lg: 0 }}>{children}</Box>
