    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          ...
          description:
            'No previous bookings were found to link to your account.',
          status: 'info',
          duration: 5000,
        });
      }
      ...
      toast({
        ...
        description:
          'There was an issue linking your existing bookings. You can link them manually later.',
        status: 'warning',
        duration: 5000,
      });
      setLinkingComplete(true);
    ...
    <Box textAlign="center" py={8}>
      ...
      <VStack spacing={4} mb={8}>
        ...
        <Text fontSize="lg" color="gray.600">
          Welcome to Speedy Van! Your account has been created and you're now
          logged in.
        </Text>
      </VStack>
              ...
              {linkedBookingsCount > 0 ? (
                <>
                  <Text fontWeight="bold" color="green.600">
                    {linkedBookingsCount} Booking
                    {linkedBookingsCount !== 1 ? 's' : ''} Found!
                  </Text>
                  <Text fontSize="sm" color="gray.600">
                    We've automatically linked {linkedBookingsCount} previous
                    booking{linkedBookingsCount !== 1 ? 's' : ''} to your
                    account.
                  </Text>
                ...
                <>
                  ...
                  <Text fontSize="sm" color="gray.600">
                    This appears to be your first booking with Speedy Van.
                    Welcome!
                  </Text>
                </>
              )}
        ...
        <Box mt={6} maxW="lg" mx="auto">
          <Alert status="info" borderRadius="md">
            ...
            <VStack align="start" spacing={2}>
              ...
              <Text fontSize="sm">
                • You can now view all your bookings in your dashboard • Future
                bookings will be automatically linked to your account • You can
                track the status of all your moves in one place
              </Text>
            </VStack>
          </Alert>
        </Box>
