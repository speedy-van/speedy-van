...
export default function EnhancedPropertyDetailsStep({
  ...
  const [isGroundFloorToGroundFloor, setIsGroundFloorToGroundFloor] =
    useState(true);
              ...
              {isGroundFloorToGroundFloor && (
                <Alert status="success">
                  ...
                  <Box>
                    ...
                    <AlertDescription>
                      No additional charges for stairs. Your move will be priced
                      at the base rate.
                    </AlertDescription>
                  </Box>
                </Alert>
            ...
            <VStack spacing={4}>
              <FormControl isRequired isInvalid={!!errors.pickupPropertyType}>
                ...
                <Select
                  ...
                  onChange={e =>
                    updatePickupProperty('propertyType', e.target.value)
                  }
                >
                ...
                <>
                  <FormControl isRequired isInvalid={!!errors.pickupFloor}>
                    ...
                    <NumberInput
                      ...
                      onChange={(_, value) =>
                        updatePickupProperty('floor', value)
                      }
                    >
            ...
            <VStack spacing={4}>
              <FormControl isRequired isInvalid={!!errors.dropoffPropertyType}>
                ...
                <Select
                  ...
                  onChange={e =>
                    updateDropoffProperty('propertyType', e.target.value)
                  }
                >
                  <option value="house">House</option>
                  <option value="apartment">Apartment</option>
                ...
                <>
                  <FormControl isRequired isInvalid={!!errors.dropoffFloor}>
                    ...
                    <NumberInput
                      ...
                      onChange={(_, value) =>
                        updateDropoffProperty('floor', value)
                      }
                    >
                      <NumberInputField placeholder="0 = Ground floor" />
                      <NumberInputStepper>
                  ...
                  <FormControl>
                    ...
                    <HStack spacing={4}>
                      <Checkbox
                        isChecked={
                          bookingData.dropoffProperty?.hasLift ?? false
                        }
                        onChange={e =>
          ...
          <Card>
            <CardBody>
              <VStack spacing={3}>
                ...
                <Text fontSize="sm" color="text.secondary">
                  • Each floor above ground level adds £10 per location • Having
                  a lift reduces stairs charges by 60% • Example: 2nd floor
                  without lift = +£10, with lift = +£4
                </Text>
              </VStack>
            </CardBody>
          </Card>
