          ...
          msgs.map(m => (
            <div
              ...
              style={{
                ...
                animation:
                  'fade-rise var(--dur-120) var(--ease-enter) forwards',
            ...
            <span aria-hidden="true" style={{ display: 'inline-flex', gap: 2 }}>
              <span
                style={{
                  ...
                  borderRadius: 999,
                  background: '#cbd5e1',
                  animation: 'dot 600ms ease-in-out infinite',
                }}
              />
              <span
                style={{
                  ...
                  borderRadius: 999,
                  background: '#cbd5e1',
                  animation: 'dot 600ms ease-in-out 150ms infinite',
                }}
              />
              <span
                style={{
                  ...
                  borderRadius: 999,
                  background: '#cbd5e1',
                  animation: 'dot 600ms ease-in-out 300ms infinite',
                }}
              />
            </span>
          </div>
