              ...
              >
                {hourEvents.map(event => (
                  ...
                  >
                    ...
                    {event.dropoff && (
                      <Text fontSize="xs">🎯 {event.dropoff}</Text>
                    )}
                  </Box>
                ))}
              </Box>
      ...
      <VStack spacing={6} align="stretch">
        ...
        {conflicts.length > 0 && (
          <Alert status="warning">
            ...
            <Box>
              ...
              <AlertDescription>
                You have {conflicts.length} overlapping events. Please review
                your schedule.
              </AlertDescription>
            </Box>
          </Alert>
        ...
        <HStack justify="space-between" p={4} bg="gray.50" borderRadius="md">
          ...
          <HStack spacing={4}>
            ...
            {conflicts.length > 0 && (
              <Badge colorScheme="red">{conflicts.length} Conflicts</Badge>
            )}
          </HStack>
        </HStack>
      </VStack>
            ...
            {selectedEvent && (
              <VStack align="stretch" spacing={4}>
                <HStack>
                  ...
                  <Badge
                    colorScheme={
                      selectedEvent.type === 'job' ? 'green' : 'orange'
                    }
                  >
                ...
                <HStack>
                  ...
                  <Text>
                    {formatEventTime(new Date(selectedEvent.start))} -{' '}
                    {formatEventTime(new Date(selectedEvent.end))}
                  </Text>
                </HStack>
