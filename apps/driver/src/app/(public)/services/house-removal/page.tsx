...
export const metadata: Metadata = {
  ...
  description:
    'Professional house removal service across the UK. Complete home moving from £150. Experienced team, full insurance, packing service available. Book your house move online.',
  keywords:
    'house removal, home removal service, house moving, professional house removals, full house removal, home relocation, house moving company',
  alternates: { canonical: 'https://speedy-van.co.uk/services/house-removal' },
  openGraph: {
    title: 'House Removal Service | Professional Home Moving | Speedy Van',
    description:
      'Professional house removal service from £150. Complete home moving with experienced team, full insurance, and packing service available.',
    url: 'https://speedy-van.co.uk/services/house-removal',
    siteName: 'Speedy Van',
    images: [
      {
        url: '/og/og-house-removal.jpg',
        width: 1200,
        height: 630,
...
const movingProcess = [
  {
    ...
    title: 'Free Survey',
    description:
      'We visit your home to assess your moving needs and provide an accurate quote',
  },
  {
    step: 2,
    title: 'Packing Day',
    description:
      'Our team arrives to professionally pack your belongings with quality materials',
  },
  {
    step: 3,
    title: 'Moving Day',
    description:
      'We carefully load, transport, and unload your items at your new home',
  },
  {
    step: 4,
    title: 'Unpacking',
    description:
      'Optional unpacking service to help you settle into your new home quickly',
  },
];
      ...
      <Container maxW="7xl" py={16}>
        ...
        <VStack spacing={8} textAlign="center" mb={16}>
          ...
          <Text fontSize="xl" color="gray.600" maxW="4xl">
            Stress-free house removals across the UK with our experienced team.
            From small flats to large family homes, we handle every aspect of
            your move with care and professionalism. Full insurance and packing
            service included.
          </Text>
        ...
        <VStack spacing={12} mt={16}>
          ...
          <Text textAlign="center" color="gray.600" maxW="2xl">
            Choose the perfect package for your home size. All packages include
            professional team, packing materials, insurance, and our
        ...
        <VStack spacing={8} mt={16}>
          ...
          <Text textAlign="center" color="gray.600" maxW="2xl">
            Enhance your house removal with our additional services. We can
            handle every aspect of your move to make the process as smooth as
            possible.
          </Text>
          ...
          <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={8} w="full">
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <VStack spacing={4} align="start">
                ...
                <Text color="gray.700">
                  "Fantastic service! The team was professional, careful with
                  our belongings, and made our house move stress-free. Highly
                  recommended!"
                </Text>
            ...
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <VStack spacing={4} align="start">
                ...
                <Text color="gray.700">
                  "Excellent house removal service. They packed everything
                  carefully and nothing was damaged. Great value for money and
                  very professional."
                </Text>
                <Text fontWeight="bold" color="gray.800">
                  - James T., Birmingham
            ...
            <Box bg="white" p={6} borderRadius="lg" shadow="md">
              <VStack spacing={4} align="start">
                ...
                <Text color="gray.700">
                  "The best house removal company we've used. Punctual,
                  efficient, and took great care of our furniture. Will
        ...
        <Box mt={16} textAlign="center" bg="blue.50" p={12} borderRadius="xl">
          <VStack spacing={6}>
            ...
            <Text fontSize="lg" color="gray.600" maxW="2xl">
              Join thousands of families who have trusted Speedy Van with their
              house removal. Get a free, no-obligation quote and book your move
              with confidence.
            </Text>
            <HStack spacing={4}>
              <Box
            ...
            __html: JSON.stringify(
              {
                ...
                description:
                  'Professional house removal service for complete home moving across the UK',
                url: 'https://speedy-van.co.uk/services/house-removal',
                provider: {
                  '@type': 'Organization',
