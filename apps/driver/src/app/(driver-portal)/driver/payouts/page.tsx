        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatHelpText>{totals.pending?.count || 0} payouts</StatHelpText>
            </Stat>
          </CardBody>
        </Card>
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatHelpText>{totals.failed?.count || 0} payouts</StatHelpText>
            </Stat>
          </CardBody>
        </Card>
      </SimpleGrid>
                      ...
                      <FormControl>
                        ...
                        <NumberInput
                          ...
                          onChange={(_, value) =>
                            setFormData({
                              ...formData,
                              minPayoutAmountPence: value * 100,
                            })
                          }
                          min={10}
                          max={10000}
                    ...
                    <Box>
                      ...
                      <VStack spacing={3} align="stretch">
                        <HStack justify="space-between">
                          ...
                          <Badge
                            colorScheme={
                              settings.hasBankDetails ? 'green' : 'red'
                            }
                          >
                        ...
                        <HStack justify="space-between">
                          ...
                          <Badge
                            colorScheme={settings.verified ? 'green' : 'yellow'}
                          >
