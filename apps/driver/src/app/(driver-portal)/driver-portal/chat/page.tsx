        ...
        >
          <VStack spacing={4} align="start">
            ...
            <Text fontSize="sm" color="gray.600">
              • <strong>Customer Chat:</strong> Communicate directly with
              customers during active bookings
            </Text>
            <Text fontSize="sm" color="gray.600">
              • <strong>Support Chat:</strong> Get help from our driver support
              team for any issues
            </Text>
            <Text fontSize="sm" color="gray.600">
            ...
            <Text fontSize="sm" color="gray.600">
              • <strong>Booking Context:</strong> Chat sessions are linked to
              specific bookings for easy reference
            </Text>
          </VStack>
        </Box>
      </VStack>
