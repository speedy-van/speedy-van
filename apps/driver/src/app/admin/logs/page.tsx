    ...
    <Box>
      <HStack justify="space-between" mb={6}>
        <VStack align="start" spacing={1}>
          ...
          <Text color="gray.600">
            Audit trails, system logs, and error tracking
          </Text>
        </VStack>
        <HStack spacing={3}>
          <Button
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatNumber color="yellow.500" suppressHydrationWarning>
                {stats.warningsToday}
              </StatNumber>
              <StatHelpText>
      ...
      {error && (
        <Alert status="error" mb={4}>
          ...
          <Button size="sm" colorScheme="blue" onClick={loadLogs} ml={4}>
            Retry
          </Button>
        </Alert>
      )}
      ...
      <Tabs
        onChange={index =>
          setActiveTab(index === 0 ? 'audit' : index === 1 ? 'system' : 'error')
        }
      >
        <TabList>
          <Tab>Audit Logs</Tab>
