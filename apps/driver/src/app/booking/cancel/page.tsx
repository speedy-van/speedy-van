        ...
        return (
          <VStack spacing={6} textAlign="center">
            ...
            <Text color="gray.600" fontSize="md" lineHeight="1.6">
              Your order has been successfully cancelled. You will not be
            ...
            <Alert status="info" borderRadius="lg">
              ...
              <Box>
                ...
                <AlertDescription fontSize="sm">
                  • Your booking has been cancelled immediately
                  <br />
                  • No charges will be made to your account
                  <br />• You can create a new booking anytime
                </AlertDescription>
              </Box>
            </Alert>
          ...
          <VStack spacing={6} textAlign="center">
            ...
            <Alert status="warning" borderRadius="lg">
              ...
              <Box>
                ...
                <AlertDescription fontSize="sm">
                  Your order may still be active. Please contact our support
                  team to confirm the status.
                </AlertDescription>
              </Box>
            </Alert>
