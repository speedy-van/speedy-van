...
const MobileStep1 = React.lazy(
  () => import('@/components/booking/mobile/MobileStep1')
);
const MobileStep2 = React.lazy(
  () => import('@/components/booking/PropertyDetailsStep')
);
const MobileStep3 = React.lazy(
  () => import('@/components/booking/DateTimeStep')
);
const MobileStep4 = React.lazy(
  () => import('@/components/booking/CustomerDetailsStep')
);
