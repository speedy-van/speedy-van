...
const faqData: FAQItem[] = [
  {
    ...
    answer:
      "You can book a moving service through our website by clicking 'Book Now' on the homepage. Fill in your pickup and delivery addresses, select your items, choose your preferred time slot, and complete the payment.",
    category: 'Booking',
  },
  {
    question: 'What items can you move?',
    answer:
      'We can move most household items including furniture, appliances, electronics, boxes, and personal belongings. We cannot move hazardous materials, perishable food, or live animals.',
    category: 'Services',
  },
  {
    question: 'How far in advance should I book?',
    answer:
      'We recommend booking at least 24-48 hours in advance to ensure availability. For weekend moves or during peak season, booking 1-2 weeks ahead is advised.',
    category: 'Booking',
  },
  {
    question: 'Can I reschedule my booking?',
    answer:
      "Yes, you can reschedule your booking up to 24 hours before your scheduled time. Log into your customer portal and go to 'My Orders' to make changes.",
    category: 'Booking',
  },
  {
    question: 'What if I need to cancel my booking?',
    answer:
      'Cancellations made more than 24 hours before your scheduled time are free. Cancellations within 24 hours may incur a fee. Please contact support for urgent cancellations.',
    category: 'Booking',
  },
  {
    question: 'How do I track my delivery?',
    answer:
      "You can track your delivery in real-time through the 'Track' section in your customer portal. You'll receive updates via email and SMS as well.",
    category: 'Tracking',
  },
  {
    question: 'What if my items are damaged during the move?',
    answer:
      'We take great care with all items, but if damage occurs, please report it within 24 hours of delivery. Take photos and contact our support team immediately.',
    category: 'Issues',
  },
  {
    question: 'Do you provide packing materials?',
    answer:
      'We offer packing materials for purchase including boxes, bubble wrap, and tape. You can add these to your booking or purchase them separately.',
    category: 'Services',
  },
  {
    question: 'What payment methods do you accept?',
    answer:
      'We accept all major credit cards, debit cards, and digital wallets. Payment is processed securely at the time of booking.',
    category: 'Payment',
  },
  {
    question: 'Can I get a receipt for my payment?',
    answer:
      "Yes, you can download receipts and invoices from the 'Invoices & Payments' section in your customer portal.",
    category: 'Payment',
  },
];
                    ...
                    <VStack spacing={4} align="stretch">
                      ...
                      <FormControl>
                        ...
                        <Text fontSize="sm" color="gray.500" mt={1}>
                          Accepted formats: PDF, JPG, PNG, DOC (max 5 files,
                          10MB each)
                        </Text>
                      </FormControl>
            ...
            <VStack spacing={4} align="stretch">
              <Alert status="info">
                ...
                <Box>
                  ...
                  <AlertDescription>
                    Send an email to <strong>support@speedy-van.co.uk</strong>{' '}
                    with your inquiry.
                  </AlertDescription>
                </Box>
              </Alert>
