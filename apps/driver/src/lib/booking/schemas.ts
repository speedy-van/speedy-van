...
export const itemSchema = z.object({
  ...
  quantity: z
    ...
    .max(20, 'Maximum 20 items per type'),
...
export const customerDetailsSchema = z.object({
  ...
  phone: z
    .string()
    .regex(UK_PHONE_REGEX, 'Please enter a valid UK mobile number'),
  alternativePhone: z
    .string()
...
export const step2Schema = z.object({
  serviceType: z.enum(['man-and-van', 'two-men-and-van', 'house-removal', 'office-removal', 'furniture-delivery', 'student-move']),
  schedule: z.object({
    date: z.string(),
...
export const step4Schema = z.object({
  ...
  privacyAccepted: z
    .boolean()
    .refine(val => val === true, 'Please accept the privacy policy'),
});
