...
async function createTestRatings() {
  try {
    ...
    const ratings = [
      {
        rating: 5,
        review: "Excellent service! Driver was very professional and careful with my items.",
    ...
    const incidents = [
      {
        ...
        description: "Engine warning light came on during delivery. Had to pull over and call roadside assistance.",
      ...
      },
      {
        ...
        description: "Heavy rain caused traffic delays and made loading more difficult.",
    ...
    console.log(`Created ${ratings.length} ratings and ${incidents.length} incidents`);
