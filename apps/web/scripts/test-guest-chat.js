...
async function testGuestChat() {
  try {
    ...
    const messagesResponse = await fetch(`http://localhost:3000/api/chat/sessions/${guestChatData.sessionId}/messages`);
    ...
    const sessionsResponse = await fetch('http://localhost:3000/api/chat/sessions');
