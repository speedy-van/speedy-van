...
import { createDriverNotification } from '../src/lib/notifications';
...
async function createTestNotifications() {
  try {
    ...
    console.log(`Creating test notifications for driver: ${driver.user.name} (${driver.user.email})`);
    ...
    const notifications = [
      ...
      },
      {
        ...
        title: 'Job Update',
        message: 'Your scheduled job has been updated. New pickup time: 2:30 PM',
      ...
      },
      {
        ...
        data: { messageId: 'test-message-1', senderId: 'customer-1', senderName: 'John Smith' },
      },
      {
      ...
      },
      {
        ...
        data: { documentId: 'test-doc-1', type: 'driving_license', expiryDate: '2024-12-15' },
      },
      {
