  ...
  try {
    ...
    const serviceAreas = await Promise.all([
      prisma.serviceArea.create({
        data: {
          name: 'Central London',
          description: 'Central London service area including Westminster, City of London, and surrounding areas',
          postcodes: ['SW1', 'SW3', 'SW5', 'SW7', 'W1', 'W2', 'W8', 'W11', 'WC1', 'WC2'],
          capacity: 50,
          status: 'active',
      ...
      prisma.serviceArea.create({
        data: {
          ...
          postcodes: ['SW', 'W', 'NW', 'N', 'E', 'SE', 'BR', 'CR', 'DA', 'EN', 'HA', 'IG', 'KT', 'RM', 'SM', 'TW', 'UB', 'WD'],
          capacity: 200,
          status: 'active',
          blackoutDates: [],
          surgeMultiplier: 1.0,
      ...
      prisma.serviceArea.create({
        data: {
          ...
          postcodes: ['M1', 'M2', 'M3', 'M4', 'M5', 'M6', 'M7', 'M8', 'M9', 'M10', 'M11', 'M12', 'M13', 'M14', 'M15', 'M16', 'M17', 'M18', 'M19', 'M20', 'M21', 'M22', 'M23', 'M24', 'M25', 'M26', 'M27', 'M28', 'M29', 'M30', 'M31', 'M32', 'M33', 'M34', 'M35', 'M38', 'M40', 'M41', 'M43', 'M44', 'M45', 'M46', 'M50', 'M90'],
          capacity: 30,
          status: 'active',
          blackoutDates: [],
          surgeMultiplier: 1.1,
    ...
    const promotions = await Promise.all([
      ...
      prisma.promotion.create({
        data: {
          ...
          status: 'active',
          applicableAreas: [serviceAreas[0].id, serviceAreas[1].id, serviceAreas[2].id],
          applicableVans: ['small', 'medium', 'large'],
          firstTimeOnly: false,
          createdBy: 'system',
        },
    ...
    const emailTemplates = await Promise.all([
      prisma.emailTemplate.create({
        data: {
          ...
          `,
          variables: ['bookingCode', 'customerName', 'pickupAddress', 'dropoffAddress', 'bookingDate', 'timeSlot', 'totalAmount'],
          category: 'booking',
          status: 'active',
          version: 1,
          createdBy: 'system',
      ...
      prisma.emailTemplate.create({
        data: {
          ...
          `,
          variables: ['bookingCode', 'customerName', 'driverName', 'vehicleType', 'estimatedArrival', 'trackingUrl'],
          category: 'booking',
          status: 'active',
          version: 1,
          createdBy: 'system',
