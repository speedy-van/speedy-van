...
test.describe('Role-Based Redirect After Authentication', () => {
  ...
  test('should automatically redirect driver to driver dashboard after sign in', async ({ page }) => {
    ...
    await page.fill('[data-testid="signin-email"]', 'test-driver@speedy-van.co.uk');
  ...
  test('should automatically redirect customer to customer portal after sign in', async ({ page }) => {
    // Go to home page and open auth modal manually
    await page.goto('/');
    await page.click('text=Sign in');
    ...
    await page.fill('[data-testid="signin-email"]', 'customer@speedy-van.co.uk');
  ...
  test('should automatically redirect admin to admin panel after sign in', async ({ page }) => {
    // Go to home page and open auth modal manually
    await page.goto('/');
    await page.click('text=Sign in');
  ...
  test('should redirect driver from driver login page to dashboard after authentication', async ({ page }) => {
  ...
  test('should redirect driver from driver portal login to dashboard after authentication', async ({ page }) => {
  ...
  test('should not redirect driver when already on driver portal', async ({ page }) => {
  ...
  test('should handle role-based redirect without browser refresh', async ({ page }) => {
    ...
    expect(navigationTiming.loadEventEnd - navigationTiming.loadEventStart).toBeLessThan(1000);
  });
});
