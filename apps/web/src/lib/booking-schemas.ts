...
export const timeSlotSchema = z.object({
  ...
  timeSlot: z.enum(['morning', 'afternoon', 'evening', 'anytime'] as const),
...
export const paymentSchema = z.object({
  method: z.enum(['card', 'bank-transfer', 'cash'] as const),
...
export type PropertyDetails = PropertyData;
export type BookingItem = ItemData;
export type TimeSlot = TimeSlotData;
