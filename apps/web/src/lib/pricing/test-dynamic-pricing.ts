...
const testInput: PricingInputs = {
  distanceMiles: 15,
  items: [
    { id: 'small-box', canonicalName: 'Small Box', quantity: 2, volumeFactor: 0.2, requiresTwoPerson: false, isFragile: false, requiresDisassembly: false, basePriceHint: 4 },
    { id: 'medium-box', canonicalName: 'Medium Box', quantity: 1, volumeFactor: 0.2, requiresTwoPerson: false, isFragile: false, requiresDisassembly: false, basePriceHint: 4 }
  ],
  pickupFloors: 2,
  pickupHasLift: false,
  dropoffFloors: 1,
