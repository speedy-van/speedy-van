...
export function createErrorResponse(error: ApplicationError, statusCode: number = 500) {
  return {
  ...
  return function ErrorBoundaryWrapper(props: T) {
    ...
    if (error) {
      ...
      return React.createElement('div', { className: 'error-boundary' },
        ...
        React.createElement('button', { onClick: () => setError(null) }, 'Try again')
      );
    }

    return React.createElement(ErrorBoundary, { onError: setError, children: 
...
class ErrorBoundary extends React.Component<
  ...
  { hasError: boolean }
> {
  constructor(props: { children: React.ReactNode; onError: (error: ApplicationError) => void }) {
    super(props);
