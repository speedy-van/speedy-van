export function formatCurrency(totalGBP: number, currency: string = "GBP"): string {
...
export function formatCurrencyShort(totalGBP: number, currency: string = "GBP"): string {
  const pounds = totalGBP / 100;
