...
class TelemetryService {
  ...
  trackDocumentUpload(documentType: string, success: boolean, fileSize?: number) {
...
export function trackPagePerformance() {
  ...
  if (navigation) {
    telemetry.trackPageLoad(window.location.pathname, navigation.loadEventEnd - navigation.loadEventStart);
  }
