...
import { Box, Container, VStack, Heading, Text, Button, HStack, Icon, useColorModeValue, SimpleGrid, Card, Avatar, Badge, Image, Flex } from '@chakra-ui/react';
import { motion } from 'framer-motion';
import { FaTruck, FaClock, FaShieldAlt, FaStar, FaCouch, FaLaptop, FaGraduationCap, FaBuilding, FaMagic, FaArrowRight, FaCheckCircle, FaMapMarkerAlt, FaPhone, FaEnvelope } from 'react-icons/fa';
...
const stats = [
  { number: '50,000+', label: 'Happy Customers', icon: FaStar, color: 'yellow' },
...
export default function HomePageContent() {
  ...
  return (
    <Box bg={bgColor} py={{ base: 8, md: 16 }} position="relative" overflow="hidden">
      {/* Background Pattern */}
      <Box
        position="absolute"
        top={0}
        ...
        <VStack spacing={{ base: 12, md: 20 }}>
                  ...
                  >
                    ...
                    >
                      <VStack spacing={3} position="relative" zIndex={1}>
                        ...
                        <Text color="text.secondary" fontSize={{ base: "xs", md: "sm" }} fontWeight="medium">
                          {stat.label}
                        </Text>
                      </VStack>
                    </Box>
                  ...
                  >
                    ...
                    >
                      <VStack spacing={4} position="relative" zIndex={1}>
                        ...
                        <Heading size={{ base: "md", md: "lg" }} mb={3} color="text.primary">
                          {feature.title}
                        </Heading>
                  ...
                  >
                    ...
                    >
                      ...
                      <VStack spacing={{ base: 4, md: 6 }} align="center" textAlign="center">
                        ...
                        <Icon as={service.icon} boxSize={{ base: 8, md: 10 }} color="neon.400" />
                        <Heading size={{ base: "md", md: "lg" }} color="white" mb={3}>
                          {service.title}
                        </Heading>
                        <Text color="gray.300" fontSize={{ base: "sm", md: "md" }} lineHeight="1.6" mb={4}>
                          {service.description}
                        </Text>
                      ...
                      <VStack spacing={{ base: 4, md: 6 }} align="stretch">
                        ...
                        <HStack spacing={4}>
                          ...
                          <VStack spacing={1} align="start">
                            ...
                            <HStack spacing={2}>
                              <Icon as={FaMapMarkerAlt} color="neon.400" boxSize={3} />
                              <Text color="neon.400" fontSize={{ base: "xs", md: "sm" }}>
                                {testimonial.city}
                              </Text>
                            </HStack>
                          </VStack>
          ...
          <Box w="full" py={{ base: 12, md: 16 }}>
            <VStack spacing={{ base: 8, md: 12 }}>
              ...
              >
                {[
                  { icon: FaPhone, title: 'Call Us', contact: '07901846297', action: 'Call Now' },
                  { icon: FaEnvelope, title: 'Email Us', contact: 'support@speedy-van.co.uk', action: 'Send Email' },
                  { icon: FaMapMarkerAlt, title: 'Visit Us', contact: 'London, UK', action: 'Get Directions' }
                ].map((contact, index) => (
                  <MotionBox
                    key={index}
                    initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <VStack spacing={{ base: 8, md: 10 }} position="relative" zIndex={1}>
              <Heading size={{ base: "xl", md: "2xl" }} color="white" mb={4}>
                Ready to Move with Confidence?
              </Heading>
              <Text color="gray.300" fontSize={{ base: "md", md: "xl" }} maxW="3xl" mx="auto" lineHeight="1.6">
