    ...
    <Box p={6}>
      <VStack align="start" spacing={6} w="full">
        <Box>
          ...
          <Text color="gray.600">
            Manage company information, VAT settings, privacy policies, and legal compliance.
          </Text>
        </Box>
        ...
        <Grid templateColumns="repeat(auto-fit, minmax(250px, 1fr))" gap={4} w="full">
          {Object.entries(mockComplianceStatus).map(([key, value]) => (
            <Card key={key} bg={bgColor} border="1px solid" borderColor={borderColor}>
              <CardBody>
                <VStack align="start" spacing={2}>
                  <HStack>
                    <Icon as={getComplianceIcon(value.status)} color={`${getComplianceColor(value.status)}.500`} />
                  ...
                  <VStack align="start" spacing={4}>
                    ...
                    <FormControl>
                      ...
                      <Switch
                        ...
                        onChange={(e) => updateSettings('vat', { enabled: e.target.checked })}
                      />
                      <FormHelperText>
                      ...
                      <Grid templateColumns="repeat(auto-fit, minmax(300px, 1fr))" gap={4} w="full">
                        <FormControl>
                          ...
                          <Input
                            ...
                            onChange={(e) => updateSettings('vat', { rate: parseFloat(e.target.value) })}
                            placeholder="20"
                          />
                          <FormHelperText>
                        ...
                        <FormControl>
                          ...
                          <Select
                            ...
                            onChange={(e) => updateSettings('vat', { country: e.target.value })}
                          >
                            {countries.map((country) => (
                              <option key={country.reference} value={country.reference}>
                                {country.name}
                              </option>
                            ))}
                          </Select>
                        ...
                        <FormControl>
                          ...
                          <Input
                            ...
                            onChange={(e) => updateSettings('vat', { registrationNumber: e.target.value })}
                    ...
                    <Grid templateColumns="repeat(auto-fit, minmax(300px, 1fr))" gap={4} w="full">
                      <FormControl>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateSettings('privacy', { policyUrl: e.target.value })}
                    ...
                    <VStack align="start" spacing={3} w="full">
                      <FormControl>
                        ...
                        <Switch
                          ...
                          onChange={(e) => updateSettings('privacy', { gdprCompliant: e.target.checked })}
                        />
                        <FormHelperText>
                      ...
                      <FormControl>
                        ...
                        <Switch
                          ...
                          onChange={(e) => updateSettings('privacy', { cookieConsent: e.target.checked })}
                        />
                        <FormHelperText>
                      ...
                      <FormControl>
                        ...
                        <Switch
                          ...
                          onChange={(e) => updateSettings('privacy', { marketingEmails: e.target.checked })}
                        />
                        <FormHelperText>
                    ...
                    <Grid templateColumns="repeat(auto-fit, minmax(300px, 1fr))" gap={4} w="full">
                      <FormControl>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateSettings('terms', { termsUrl: e.target.value })}
                      ...
                      <FormControl>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateSettings('terms', { version: e.target.value })}
                          placeholder="2.1"
                        />
                      </FormControl>
                      ...
                      <FormControl>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateSettings('terms', { lastUpdated: e.target.value })}
                        />
                      </FormControl>
                    </Grid>
                  ...
                  <VStack align="start" spacing={4}>
                    ...
                    <VStack align="start" spacing={3} w="full">
                      <FormControl>
                        ...
                        <Switch
                          ...
                          onChange={(e) => updateSettings('cookies', { essential: e.target.checked })}
                        />
                        <FormHelperText>
                      ...
                      <FormControl>
                        ...
                        <Switch
                          ...
                          onChange={(e) => updateSettings('cookies', { analytics: e.target.checked })}
                        />
                        <FormHelperText>
                      ...
                      <FormControl>
                        ...
                        <Switch
                          ...
                          onChange={(e) => updateSettings('cookies', { marketing: e.target.checked })}
                        />
                        <FormHelperText>
                      ...
                      <FormControl>
                        ...
                        <Switch
                          ...
                          onChange={(e) => updateSettings('cookies', { preferences: e.target.checked })}
                        />
                        <FormHelperText>
                      ...
                      <FormControl>
                        ...
                        <Input
                          ...
                          onChange={(e) => updateSettings('cookies', { retentionDays: parseInt(e.target.value) })}
                          placeholder="365"
                        />
                        <FormHelperText>
                    ...
                    <Alert status="info" borderRadius="md">
                      ...
                      <Box>
                        ...
                        <Text fontSize="sm">
                          Users will be shown a cookie consent banner based on these settings. 
        ...
        <Card bg={bgColor} border="1px solid" borderColor={borderColor}>
          <CardBody>
            <VStack align="start" spacing={4}>
              ...
              <Text color="gray.600">
                Export and manage your legal documents for compliance and record-keeping.
              </Text>
