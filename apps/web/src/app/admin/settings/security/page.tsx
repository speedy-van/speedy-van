...
export default function SecuritySettings() {
  ...
  const removeIPFromList = (listType: 'allowlist' | 'blocklist', ip: string) => {
    const list = settings.ipSecurity[listType];
    updateSettings('ipSecurity', {
          ...
          <Card bg={bgColor} border="1px solid" borderColor={borderColor}>
            <CardBody>
              <Stat>
                ...
                <StatHelpText>
                  <StatArrow type={mockSecurityStats.securityScoreChange > 0 ? 'increase' : 'decrease'} />
          ...
          <Card bg={bgColor} border="1px solid" borderColor={borderColor}>
            <CardBody>
              <Stat>
                ...
                <StatHelpText>
                  <StatArrow type={mockSecurityStats.failedLoginsChange > 0 ? 'increase' : 'decrease'} />
          ...
          <Card bg={bgColor} border="1px solid" borderColor={borderColor}>
            <CardBody>
              <Stat>
                ...
                <StatHelpText>
                  <StatArrow type={mockSecurityStats.activeSessionsChange > 0 ? 'increase' : 'decrease'} />
          ...
          <Card bg={bgColor} border="1px solid" borderColor={borderColor}>
            <CardBody>
              <Stat>
                ...
                <StatHelpText>
                  <StatArrow type={mockSecurityStats.blockedIPsChange > 0 ? 'increase' : 'decrease'} />
            ...
            <VStack align="start" spacing={4}>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => updateSettings('twoFactorAuth', { enabled: e.target.checked })}
                />
                <FormHelperText>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => updateSettings('twoFactorAuth', { requiredForAdmins: e.target.checked })}
                />
                <FormHelperText>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => updateSettings('twoFactorAuth', { backupCodesEnabled: e.target.checked })}
                />
                <FormHelperText>
            ...
            <VStack align="start" spacing={4}>
              ...
              <FormControl>
                ...
                <Input
                  ...
                  onChange={(e) => updateSettings('sessionManagement', { timeoutMinutes: parseInt(e.target.value) })}
                  placeholder="480"
                />
                <FormHelperText>
              ...
              <FormControl>
                ...
                <Input
                  ...
                  onChange={(e) => updateSettings('sessionManagement', { maxConcurrentSessions: parseInt(e.target.value) })}
                  placeholder="3"
                />
                <FormHelperText>
              ...
              <FormControl>
                ...
                <Switch
                  isChecked={settings.sessionManagement.forceLogoutOnPasswordChange}
                  onChange={(e) => updateSettings('sessionManagement', { forceLogoutOnPasswordChange: e.target.checked })}
                />
                <FormHelperText>
                ...
                <VStack align="start" spacing={3}>
                  <FormControl>
                    ...
                    <Switch
                      ...
                      onChange={(e) => updateSettings('ipSecurity', { allowlistEnabled: e.target.checked })}
                    />
                    <FormHelperText>
                  ...
                  {settings.ipSecurity.allowlistEnabled && (
                    <VStack align="start" spacing={2} w="full">
                      <Text fontSize="sm" fontWeight="medium">Allowed IPs:</Text>
                      {settings.ipSecurity.allowlist.map((ip, index) => (
                        <HStack key={index} w="full">
                          <Text fontSize="sm" flex={1}>{ip}</Text>
                          <IconButton
                            size="sm"
                            icon={<FiTrash2 />}
                            variant="ghost"
                      ...
                      <Button size="sm" variant="outline" leftIcon={<FiPlus />} onClick={onOpen}>
                        Add IP
                      </Button>
                    </VStack>
                  )}
                ...
                <VStack align="start" spacing={3}>
                  <FormControl>
                    ...
                    <Switch
                      ...
                      onChange={(e) => updateSettings('ipSecurity', { blocklistEnabled: e.target.checked })}
                    />
                    <FormHelperText>
                  ...
                  {settings.ipSecurity.blocklistEnabled && (
                    <VStack align="start" spacing={2} w="full">
                      <Text fontSize="sm" fontWeight="medium">Blocked IPs:</Text>
            ...
            <VStack align="start" spacing={4}>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => updateSettings('sso', { enabled: e.target.checked })}
                />
                <FormHelperText>
                ...
                <VStack align="start" spacing={3} w="full">
                  <FormControl>
                    ...
                    <Select
                      ...
                      onChange={(e) => updateSettings('sso', { provider: e.target.value })}
                    >
                  ...
                  <FormControl>
                    ...
                    <Input
                      ...
                      onChange={(e) => updateSettings('sso', { callbackUrl: e.target.value })}
            ...
            <VStack align="start" spacing={4}>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => updateSettings('audit', { enabled: e.target.checked })}
                />
                <FormHelperText>
                ...
                <VStack align="start" spacing={3} w="full">
                  ...
                  <FormControl>
                    ...
                    <Switch
                      ...
                      onChange={(e) => updateSettings('audit', { logFailedLogins: e.target.checked })}
                    />
                  </FormControl>
                  ...
                  <FormControl>
                    ...
                    <Switch
                      ...
                      onChange={(e) => updateSettings('audit', { logAdminActions: e.target.checked })}
                    />
                  </FormControl>
          ...
          <ModalBody>
            <VStack spacing={4}>
              ...
              <FormControl>
                ...
                <Select
                  value={listType}
                  onChange={(e) => setListType(e.target.value as 'allowlist' | 'blocklist')}
                >
