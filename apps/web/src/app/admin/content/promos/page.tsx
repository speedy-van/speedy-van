...
import { FiPlus, FiEdit, FiEye, FiTrash2, FiSave, FiX, FiGift } from 'react-icons/fi';
  ...
  return (
    <Box>
      ...
      <Alert status="info" mb={6}>
        <AlertIcon />
        Promotions can be percentage or fixed discounts with usage limits and validity periods.
      </Alert>
                ...
                <Tr key={promo.id}>
                  ...
                  <Td>
                    <VStack align="start" spacing={1}>
                      ...
                      <Progress 
                        ...
                        size="sm" 
                        colorScheme={getUsagePercentage(promo) > 80 ? 'red' : 'green'}
                        w="100px"
                      />
                    </VStack>
                  </Td>
                  ...
                  <Td>
                    <Badge colorScheme={getStatusColor(promo.status)}>
                      {isExpired(promo) ? 'Expired' : isScheduled(promo) ? 'Scheduled' : promo.status}
                    </Badge>
                  </Td>
                  <Td>
                    <HStack spacing={2}>
                ...
                <GridItem>
                  <FormControl isRequired>
                    ...
                    <NumberInput
                      ...
                      onChange={(value) => setFormData({ ...formData, value: parseFloat(value) })}
                      min={0}
                ...
                <GridItem>
                  <FormControl>
                    ...
                    <NumberInput
                      ...
                      onChange={(value) => setFormData({ ...formData, minSpend: parseFloat(value) })}
                      min={0}
                      precision={2}
                    >
                      <NumberInputField />
                ...
                <GridItem>
                  <FormControl>
                    ...
                    <NumberInput
                      ...
                      onChange={(value) => setFormData({ ...formData, maxDiscount: parseFloat(value) })}
                      min={0}
                      precision={2}
                    >
                      <NumberInputField />
                ...
                <GridItem>
                  <FormControl>
                    ...
                    <NumberInput
                      ...
                      onChange={(value) => setFormData({ ...formData, usageLimit: parseInt(value) })}
                      min={1}
                      max={100000}
                    >
                      <NumberInputField />
              ...
              <FormControl>
                ...
                <HStack spacing={2} mt={2} flexWrap="wrap">
                  {formData.applicableAreas.map((area) => (
                    <Tag key={area} size="md" colorScheme="blue" borderRadius="full">
              ...
              <FormControl>
                ...
                <HStack spacing={2} mt={2} flexWrap="wrap">
                  {formData.applicableVans.map((van) => (
                    <Tag key={van} size="md" colorScheme="green" borderRadius="full">
