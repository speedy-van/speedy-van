...
import { Box, Heading, HStack, VStack, Text, Badge, Card, CardBody, Button, Tabs, TabList, TabPanels, Tab, TabPanel, Grid, GridItem, Table, Thead, Tbody, Tr, Th, Td, Input, Select, Switch, FormControl, FormLabel } from "@chakra-ui/react";
import { FiSettings, FiMapPin, FiTag, FiPlus, FiEdit, FiTrash2, FiEye } from "react-icons/fi";
                      ...
                      <Tr key={area.id}>
                        ...
                        <Td>
                          <HStack spacing={2}>
                            ...
                            <Button size="xs" leftIcon={<FiMapPin />} variant="outline">
                              Map
                            </Button>
                            <Button size="xs" leftIcon={<FiTrash2 />} colorScheme="red" variant="outline">
                              Delete
                            </Button>
                          </HStack>
                        </Td>
          ...
          <HStack justify="space-between">
            <VStack align="start" spacing={1}>
              ...
              <Text fontSize="sm" color="gray.600">
                All changes are versioned and can be reverted. Preview changes before publishing.
              </Text>
            </VStack>
            <HStack spacing={3}>
