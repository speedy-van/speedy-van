        ...
        <CardBody>
          <HStack spacing={4} wrap="wrap">
            ...
            <Button
              leftIcon={<FiFilter />}
              variant="outline"
              onClick={() => setFilters({ search: '', status: '', fromDate: '', toDate: '', customerId: '' })}
            >
              Clear Filters
            </Button>
          </HStack>
            ...
            <CardBody>
              <HStack>
                ...
                <VStack align="start" spacing={0}>
                  ...
                  <Text fontSize="xl" fontWeight="bold">{data.summary.totalInvoices}</Text>
                </VStack>
              </HStack>
            </CardBody>
          </Card>
            ...
            <CardBody>
              <HStack>
                ...
                <VStack align="start" spacing={0}>
                  ...
                  <Text fontSize="xl" fontWeight="bold">{data.invoices.length} of {data.pagination.total}</Text>
                </VStack>
              </HStack>
            </CardBody>
          </Card>
          ...
          <Table variant="simple">
            ...
            <Tbody>
              {data?.invoices.map((invoice) => (
                <Tr key={invoice.id}>
                  <Td>
                    <Text fontWeight="bold" fontSize="sm">{invoice.invoiceNumber || 'N/A'}</Text>
                  </Td>
                  <Td>
                  ...
                  <Td>
                    <VStack align="start" spacing={0}>
                      <Text fontSize="sm" fontWeight="medium">{invoice.customer.name}</Text>
                  ...
                  <Td>
                    <Text fontSize="sm">{invoice.driver?.name || 'Unassigned'}</Text>
                  </Td>
                  <Td>
                    <Menu>
                      <MenuButton
                      ...
                      />
                      <MenuList>
                        <MenuItem icon={<FiEye />} onClick={() => handleViewInvoice(invoice)}>
                          View Details
                        </MenuItem>
                        <MenuItem icon={<FiDownload />} onClick={() => handleGeneratePDF(invoice)}>
                          Download PDF
                        </MenuItem>
            ...
            {selectedInvoice && (
              <VStack spacing={4} align="stretch">
                ...
                <HStack justify="space-between">
                  ...
                  <Text>{selectedInvoice.paidAt ? new Date(selectedInvoice.paidAt).toLocaleDateString() : 'N/A'}</Text>
                </HStack>
                <HStack justify="space-between">
