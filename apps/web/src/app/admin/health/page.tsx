    ...
    <Box>
      ...
      {healthData && (
        <>
            ...
            <Card>
              <CardBody>
                <Stat>
                  ...
                  <StatNumber>{healthData.performanceMetrics.avgResponseTime}</StatNumber>
                  <StatHelpText>
            ...
            <Card>
              <CardBody>
                <Stat>
                  ...
                  <StatNumber color="red.500">{healthData.performanceMetrics.errorRate}</StatNumber>
                  <StatHelpText>
            ...
            <Card>
              <CardBody>
                <Stat>
                  ...
                  <StatNumber>{healthData.performanceMetrics.activeUsers}</StatNumber>
                  <StatHelpText>
                      ...
                      <Card key={service} variant="outline">
                        <CardBody>
                          <HStack justify="space-between">
                            <VStack align="start" spacing={1}>
                              <HStack>
                                <Text fontWeight="bold" textTransform="capitalize">{service}</Text>
                                <Badge colorScheme={getStatusColor(data.status)} size="sm">
                                  {data.status}
                                </Badge>
                              </HStack>
                              <Text fontSize="sm" color="gray.600">
            ...
            <VStack spacing={6} align="stretch">
                  ...
                  <VStack spacing={3} align="stretch">
                    {healthData.recentIncidents.map((incident) => (
                      <Alert key={incident.id} status={getSeverityColor(incident.severity) as any} variant="left-accent">
                        <AlertIcon />
                        <VStack align="start" spacing={1}>
                          <AlertTitle fontSize="sm">{incident.service}</AlertTitle>
                          <AlertDescription fontSize="sm">{incident.message}</AlertDescription>
              ...
              <Card>
                <CardBody>
                  ...
                  <VStack spacing={3} align="stretch">
                    <Button leftIcon={<FiDatabase />} variant="outline" size="sm">
                ...
                <CardBody>
                  ...
                  <VStack spacing={3} align="stretch">
                    <HStack justify="space-between">
                      ...
                      <Badge colorScheme="blue" size="sm">Production</Badge>
                    </HStack>
                    <HStack justify="space-between">
          ...
          <Card mt={6}>
            <CardBody>
              <Heading size="md" mb={4}>Health Checks</Heading>
