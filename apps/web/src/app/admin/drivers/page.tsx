...
export default function AdminDriversPage() {
  ...
  const handleDriverAction = async (action: string, driverId: string, data?: any) => {
    setProcessing(true);
    try {
  ...
  const getComplianceStatus = (driver: Driver) => {
    ...
    if (issues === 0) return { status: 'compliant', color: 'green', text: 'Compliant' };
    if (issues <= 2) return { status: 'warning', color: 'yellow', text: `${issues} issues` };
    return { status: 'critical', color: 'red', text: `${issues} critical issues` };
  };
  ...
  const filteredDrivers = drivers.filter(driver => {
    ...
    const matchesCompliance = complianceFilter === 'all' || 
      (complianceFilter === 'compliant' && driver.complianceIssues.length === 0) ||
      (complianceFilter === 'issues' && driver.complianceIssues.length > 0);
    
    return matchesSearch && matchesStatus && matchesAvailability && matchesCompliance;
  });
            ...
            <Table variant="simple">
              ...
              <Tbody>
                {filteredDrivers.map((driver) => {
                  ...
                  return (
                    <Tr key={driver.id} cursor="pointer" onClick={() => {
                      ...
                      <Td>
                        <Badge colorScheme={getAvailabilityColor(driver.availability)}>
                          {driver.availability}
                        </Badge>
                      </Td>
                      <Td>
                      ...
                      <Td>
                        <Menu>
                          ...
                          <MenuList>
                            ...
                            <MenuItem icon={<FiSettings />} onClick={(e) => {
                              e.stopPropagation();
                              // Open settings modal
                            }}>
                              Settings
                      ...
                      <Grid templateColumns="1fr 1fr" gap={6}>
                        <VStack align="start" spacing={4}>
                          ...
                          <VStack align="start" spacing={2}>
                            <HStack>
                              <Icon as={FiUser} />
                              <Text fontWeight="medium">{selectedDriver.name}</Text>
                            </HStack>
                            <HStack>
                              <Icon as={FiMail} />
                        ...
                        <VStack align="start" spacing={4}>
                          ...
                          <VStack align="start" spacing={2}>
                            ...
                            <HStack>
                              <Badge colorScheme={getAvailabilityColor(selectedDriver.availability)}>
                            ...
                            <HStack>
                              <Icon as={FiClock} />
                              <Text fontSize="sm">
                                Last seen: {selectedDriver.lastSeen ? new Date(selectedDriver.lastSeen).toLocaleString() : 'Never'}
                              </Text>
                            </HStack>
                          </VStack>
                        </VStack>
                      ...
                      <VStack align="start" spacing={4}>
                        ...
                        <Grid templateColumns="repeat(auto-fit, minmax(200px, 1fr))" gap={4} w="full">
                          ...
                          <Card>
                            <CardBody>
                              <VStack spacing={2}>
                                <Icon as={FiDollarSign} size="24px" color="green.500" />
                    ...
                    <VStack spacing={6} align="stretch">
                      ...
                      <Grid templateColumns="repeat(auto-fit, minmax(250px, 1fr))" gap={4}>
                        <Card>
                          <CardBody>
                            <VStack spacing={2}>
                              <Icon as={FiShieldIcon} size="24px" color="blue.500" />
                              <Text fontWeight="medium">License</Text>
                              <Badge colorScheme={selectedDriver.documentExpiries.license ? 'red' : 'green'}>
                        ...
                        <Card>
                          <CardBody>
                            <VStack spacing={2}>
                              <Icon as={FiShieldIcon} size="24px" color="purple.500" />
                              <Text fontWeight="medium">Insurance</Text>
                              <Badge colorScheme={selectedDriver.documentExpiries.insurance ? 'red' : 'green'}>
                        ...
                        <Card>
                          <CardBody>
                            <VStack spacing={2}>
                              <Icon as={FiTruck} size="24px" color="orange.500" />
                              <Text fontWeight="medium">MOT</Text>
                              <Badge colorScheme={selectedDriver.documentExpiries.mot ? 'red' : 'green'}>
                        ...
                        <VStack align="start" spacing={4}>
                          ...
                          <FormControl>
                            ...
                            <Input 
                              ...
                              max={10}
                            />
                            <FormHelperText>Maximum jobs this driver can be auto-assigned</FormHelperText>
                          </FormControl>
