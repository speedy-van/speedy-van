                    ...
                    <CardBody>
                      <SimpleGrid columns={2} spacing={4}>
                        <Box>
                          ...
                          <Text>{selectedApplication.bankInfo?.accountHolderName || 'N/A'}</Text>
                        </Box>
                        <Box>
                          <Text fontWeight="medium">Bank Name</Text>
                          <Text>{selectedApplication.bankInfo?.bankName || 'N/A'}</Text>
                        </Box>
                        <Box>
                          <Text fontWeight="medium">Sort Code</Text>
                          <Text>{selectedApplication.bankInfo?.sortCode || 'N/A'}</Text>
                        </Box>
                        <Box>
                          <Text fontWeight="medium">Account Number</Text>
                          <Text>{selectedApplication.bankInfo?.accountNumber || 'N/A'}</Text>
                        </Box>
                      </SimpleGrid>
                    </CardBody>
                  </Card>
