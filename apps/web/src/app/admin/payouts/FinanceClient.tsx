...
export default function FinanceClient({ data }: FinanceClientProps) {
  ...
  return (
    <Box>
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatNumber>{formatCurrency(data.revenueMetrics.totalRevenue)}</StatNumber>
              <StatHelpText>
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatNumber>{formatCurrency(data.earningsBreakdown.netAmount)}</StatNumber>
              <StatHelpText>
                <StatArrow type="increase" />
                15.3%
              </StatHelpText>
      ...
      {/* Main Content */}
      <Tabs index={parseInt(selectedTab)} onChange={(index) => setSelectedTab(index.toString())}>
        <TabList>
          <Tab>Overview</Tab>
          <Tab>Invoices</Tab>
          <Tab>Refunds</Tab>
              ...
              <Card>
                ...
                <CardBody>
                  <VStack spacing={4} align="stretch">
                    <Text fontWeight="bold" color="gray.600">Recent Invoices</Text>
                ...
                <Card>
                  ...
                  <CardBody>
                    <VStack spacing={3} align="stretch">
                      <Button leftIcon={<FaFileInvoice />} variant="outline" size="sm">
                        Generate Invoice
                      </Button>
                      <Button leftIcon={<FaUndo />} variant="outline" size="sm">
                        Issue Refund
                      </Button>
                      <Button leftIcon={<FaMoneyBillWave />} variant="outline" size="sm">
                        Process Payouts
                      </Button>
                      <Button leftIcon={<FaChartLine />} variant="outline" size="sm">
                        View Reports
                      </Button>
                    </VStack>
                  </CardBody>
                      ...
                      {data.pendingRefunds.length > 0 && (
                        <Alert status="warning" size="sm">
                          ...
                          <Box>
                            ...
                            <AlertDescription>
                              {data.pendingRefunds.length} refunds awaiting processing
                            </AlertDescription>
                          </Box>
                        </Alert>
                      )}
            ...
            <Card>
              ...
              <CardBody>
                <VStack spacing={6} align="stretch">
                    ...
                    <Card>
                      <CardBody>
                        <Stat>
                          ...
                          <StatNumber>{formatCurrency(data.earningsBreakdown.baseAmount)}</StatNumber>
                        </Stat>
                      </CardBody>
                    </Card>
                    <Card>
                      <CardBody>
                        <Stat>
                          ...
                          <StatNumber>{formatCurrency(data.earningsBreakdown.surgeAmount)}</StatNumber>
                        </Stat>
                      </CardBody>
                    </Card>
                    <Card>
                      <CardBody>
                        <Stat>
                          ...
                          <StatNumber>{formatCurrency(data.earningsBreakdown.tipAmount)}</StatNumber>
                        </Stat>
                      </CardBody>
                    </Card>
                    <Card>
                  ...
                  <Text fontWeight="bold" color="gray.600">Detailed Breakdown</Text>
                  <Table variant="simple" size="sm">
                    ...
                    <Tbody>
                      <Tr>
                        <Td>Base Earnings</Td>
                        <Td>{formatCurrency(data.earningsBreakdown.baseAmount)}</Td>
                        <Td>
                      ...
                      <Tr>
                        ...
                        <Td>{formatCurrency(data.earningsBreakdown.surgeAmount)}</Td>
                        <Td>
                          {data.earningsBreakdown.netAmount > 0 
                      ...
                      <Tr>
                        <Td>Tips</Td>
                        <Td>{formatCurrency(data.earningsBreakdown.tipAmount)}</Td>
                        <Td>
                          {data.earningsBreakdown.netAmount > 0 
                      ...
                      <Tr>
                        <Td>Fees</Td>
                        <Td>{formatCurrency(data.earningsBreakdown.feeAmount)}</Td>
                        <Td>
                          {data.earningsBreakdown.netAmount > 0 
            ...
            <VStack spacing={4} align="stretch">
              ...
              <Alert status="info">
                ...
                <Box>
                  ...
                  <AlertDescription>
                    Refunds will be processed through Stripe and may take 5-10 business days to appear on the customer's statement.
                  </AlertDescription>
                </Box>
              </Alert>
              ...
              <HStack spacing={4} justify="flex-end">
                ...
                <Button colorScheme="red" onClick={() => handleIssueRefund('temp-id')}>
                  Issue Refund
                </Button>
              </HStack>
            </VStack>
