...
import { Box, Container, VStack, Heading, Text, FormControl, FormLabel, Input, Button, Alert, AlertIcon, Card, CardBody, Link as ChakraLink, IconButton, HStack, Icon, Badge, Divider, useColorModeValue } from "@chakra-ui/react";
import { signIn, getCsrfToken, useSession } from "next-auth/react";
import { useRouter } from "next/navigation";
import NextLink from "next/link";
import { ChevronLeftIcon } from "@chakra-ui/icons";
import { FaTruck, FaShieldAlt, FaUser, FaLock, FaSignInAlt, FaArrowRight, FaMapMarkerAlt, FaClock, FaStar, FaHome } from "react-icons/fa";
                ...
                <VStack spacing={8} align="start">
                  <VStack spacing={6} align="start">
                    ...
                    <Text color="text.secondary" fontSize="md" lineHeight="1.6">
                      Join our network of professional drivers and enjoy flexible hours, 
                      competitive pay, and the support you need to succeed.
                    </Text>
                  </VStack>
                    ...
                    {[
                      {
                        ...
                        description: "Choose your own hours and work when it suits you"
                      },
                      {
                        icon: FaMapMarkerAlt,
                      ...
                      },
                      {
                        ...
                        description: "Get paid within 48 hours of job completion"
                      },
                      {
                        icon: FaShieldAlt,
                        title: "Full Support",
                      ...
                      >
                        <HStack spacing={4}>
                          ...
                          <VStack align="start" spacing={1}>
                            ...
                            <Text color="text.secondary" fontSize="sm" lineHeight="1.4">
                              {benefit.description}
                            </Text>
                          </VStack>
                        </HStack>
