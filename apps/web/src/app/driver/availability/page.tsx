    ...
    <Container maxW="container.xl" py={8}>
      <VStack spacing={12} align="stretch">
            ...
            <VStack spacing={6} align="stretch">
              <HStack justify="space-between" align="center">
                <VStack align="start" spacing={1}>
                  <Heading size="lg" color="gray.700">Location Sharing</Heading>
                  <Text color="gray.600">
              ...
              <VStack spacing={4} align="stretch">
                <HStack justify="space-between" align="center" p={4} bg="gray.50" borderRadius="lg">
                  <VStack align="start" spacing={1}>
                    <Text fontWeight="semibold" color="gray.800">Share Location</Text>
        ...
        <Card>
          <CardBody p={8}>
            <VStack spacing={6} align="stretch">
              <Heading size="lg" color="gray.700">Working Hours</Heading>
              ...
              <VStack spacing={4} align="stretch">
                {Object.entries(settings.workingHours).map(([day, hours]) => (
                  <Box 
                    key={day} 
                    p={6} 
                    bg={hours.enabled ? "green.50" : "gray.50"} 
                    borderWidth={2} 
                    borderColor={hours.enabled ? "green.200" : "gray.200"}
                    borderRadius="lg"
                    transition="all 0.2s"
                  >
                    <Flex justify="space-between" align="center" direction={{ base: "column", md: "row" }} gap={4}>
                      <HStack spacing={4}>
                        <FormControl display="flex" alignItems="center" w="auto">
                          <FormLabel 
                            ...
                            fontWeight="bold" 
                            fontSize="lg"
                            color={hours.enabled ? "green.700" : "gray.500"}
                            minW="120px"
                          >
                      ...
                      {hours.enabled && (
                        <HStack spacing={4} flexWrap="wrap">
                          <HStack spacing={2}>
                            <Text fontSize="md" fontWeight="medium" color="gray.700">From:</Text>
                            <Box
                              as="input"
                              type="time"
                              value={hours.start}
                          ...
                          <HStack spacing={2}>
                            <Text fontSize="md" fontWeight="medium" color="gray.700">To:</Text>
                            <Box
                              as="input"
                              type="time"
                              value={hours.end}
        ...
        <Card>
          <CardBody p={8}>
            <VStack spacing={6} align="stretch">
              <Heading size="lg" color="gray.700">Service Coverage</Heading>
