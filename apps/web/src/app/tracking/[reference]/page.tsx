                  ...
                  <VStack spacing={4} flex={1}>
                    ...
                    <HStack spacing={3} align="start" w="full">
                      ...
                      <VStack align="start" spacing={1} flex={1}>
                        ...
                        <Text fontSize="sm">{pageData.locations.pickup.address}</Text>
                        {pageData.locations.pickup.postcode && (
                    ...
                    <HStack spacing={3} align="start" w="full">
                      ...
                      <VStack align="start" spacing={1} flex={1}>
                        ...
                        <Text fontSize="sm">{pageData.locations.dropoff.address}</Text>
                        {pageData.locations.dropoff.postcode && (
                          <Text fontSize="xs" color="gray.500">
                            {pageData.locations.dropoff.postcode}
                          </Text>
                        )}
