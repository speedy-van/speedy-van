...
import { FaCheckCircle, FaHome, FaDownload, FaEnvelope, FaFilePdf } from 'react-icons/fa';
...
export default function BookingSuccessPage() {
  ...
  const generatePDFInvoice = (invoiceData: any) => {
    ...
    // Invoice Details
    addText(`Invoice Number: ${invoiceData.content.invoice.number}`, 20, yPosition, 12);
    ...
    addText(`£${invoiceData.content.totals.vat.toFixed(2)}`, 170, yPosition, 12);
    yPosition += 8;
    addLine(yPosition);
    yPosition += 8;
  ...
  const sendEmail = async () => {
    ...
    try {
      ...
      toast({
        title: 'Email Failed',
        description: 'There was an issue sending the confirmation email. Please try again.',
        status: 'error',
        duration: 5000,
        isClosable: true,
      });
      ...
      <Container maxW="2xl">
        <VStack spacing={8} align="stretch">
          ...
          <Box textAlign="center">
            ...
            {/* Payment Details */}
            <Box p={6} bg="white" borderRadius="lg" shadow="sm" border="1px" borderColor="green.200" maxW="md" mx="auto">
              <VStack spacing={4}>
          ...
          <Box p={6} bg="white" borderRadius="lg" shadow="sm">
            ...
            <VStack align="start" spacing={4}>
              <HStack>
                <Badge colorScheme="blue" borderRadius="full" p={2}>1</Badge>
                <Text>You'll receive a confirmation email within 5 minutes</Text>
              </HStack>
              <HStack>
                <Badge colorScheme="blue" borderRadius="full" p={2}>2</Badge>
                <Text>Our team will call you within 2 hours to confirm details</Text>
              </HStack>
              <HStack>
                <Badge colorScheme="blue" borderRadius="full" p={2}>3</Badge>
                <Text>We'll send you the driver's contact details 24 hours before your move</Text>
              </HStack>
              <HStack>
                <Badge colorScheme="blue" borderRadius="full" p={2}>4</Badge>
          ...
          <VStack spacing={4}>
            ...
            <Button
              ...
              h="50px"
            >
              {isSendingEmail ? 'Sending Email...' : 'Resend Confirmation Email'}
            </Button>
          ...
          <Box p={4} bg="blue.50" borderRadius="lg" border="1px" borderColor="blue.200">
            <VStack spacing={2} align="start">
              <HStack>
                ...
                <Text fontWeight="semibold" color="blue.700">Invoice Details:</Text>
              </HStack>
