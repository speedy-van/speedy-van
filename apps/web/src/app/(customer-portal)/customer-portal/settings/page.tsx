...
import { ViewIcon, ViewOffIcon, ExternalLinkIcon, DownloadIcon, DeleteIcon } from "@chakra-ui/icons";
...
export default function CustomerSettingsPage() {
  ...
  const requestAccountDeletion = async () => {
    try {
      ...
      if (response.ok) {
        toast({
          title: "Request Submitted",
          description: "Your account deletion request has been submitted. Our team will contact you within 30 days.",
          status: "success",
          duration: 5000,
        });
      }
  ...
  return (
    <VStack spacing={8} align="stretch">
          ...
          <FormControl>
            ...
            {settings?.profile.emailVerified && (
              <HStack mt={2}>
                ...
                <Text fontSize="sm" color="green.500">Email verified</Text>
              </HStack>
            )}
          </FormControl>
        </Grid>
        ...
        <VStack align="stretch" spacing={4}>
          ...
          <HStack justify="space-between">
            <VStack align="start" spacing={1}>
              ...
              <Text fontSize="sm" color="gray.600">Receive updates about your bookings via SMS</Text>
            </VStack>
            <Switch
          ...
          <HStack justify="space-between">
            <VStack align="start" spacing={1}>
              ...
              <Text fontSize="sm" color="gray.600">Receive real-time updates in your browser</Text>
            </VStack>
            <Switch
      ...
      {/* Privacy Section */}
      <Box borderWidth="1px" borderRadius="lg" p={6} bg="white">
        <Heading size="md" mb={4}>Privacy & Data</Heading>
        <VStack align="stretch" spacing={4}>
          <HStack justify="space-between">
            <VStack align="start" spacing={1}>
              <Text fontWeight="medium">Data Export</Text>
              <Text fontSize="sm" color="gray.600">Download a copy of your personal data</Text>
            </VStack>
            <Button
              size="sm"
          ...
          <HStack justify="space-between">
            <VStack align="start" spacing={1}>
              ...
              <Text fontSize="sm" color="gray.600">Permanently delete your account and data</Text>
            </VStack>
            <Button
              size="sm"
              colorScheme="red"
      ...
      <Modal isOpen={is2FAOpen} onClose={on2FAClose} size="lg">
        ...
        <ModalContent>
          <ModalHeader>
            {settings?.security.twoFactorEnabled ? "Disable Two-Factor Authentication" : "Setup Two-Factor Authentication"}
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <VStack spacing={4}>
          ...
          <ModalFooter>
            ...
            <Button
              colorScheme={settings?.security.twoFactorEnabled ? "red" : "blue"}
              onClick={settings?.security.twoFactorEnabled ? disable2FA : verify2FA}
            >
              {settings?.security.twoFactorEnabled ? "Disable 2FA" : "Verify & Enable"}
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
