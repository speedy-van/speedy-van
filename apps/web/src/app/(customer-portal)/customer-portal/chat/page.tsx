            ...
            {selectedSessionId ? (
              ...
              >
                ...
                <Text fontSize="sm" color="gray.500" maxW="300px" mb={4}>
                  Choose a conversation from the list to start chatting with drivers or support staff
                </Text>
                <Button
                  leftIcon={<PlusIcon size={16} />}
                  colorScheme="blue"
        ...
        <Box bg={bgColor} p={6} borderRadius="lg" border="1px solid" borderColor={borderColor}>
          <VStack spacing={4} align="start">
            ...
            <Text fontSize="sm" color="gray.600">
              • <strong>Driver Chat:</strong> Communicate directly with your assigned driver during active bookings
            </Text>
            <Text fontSize="sm" color="gray.600">
              • <strong>Support Chat:</strong> Get help from our customer support team for any questions or issues
            </Text>
            <Text fontSize="sm" color="gray.600">
