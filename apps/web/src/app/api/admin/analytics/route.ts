...
export async function GET(request: Request) {
  try {
    ...
    const [bookingCounts, revenue30d, revenue7d, revenue24h, recentBookings] = await Promise.all([
    ...
    const payload = {
      ...
      driverMetrics: [
        { driverId: '1', driverName: 'John Smith', completedJobs: 45, avgRating: 4.8, earnings: 1250, onTimeRate: 95 },
        { driverId: '2', driverName: 'Sarah Johnson', completedJobs: 38, avgRating: 4.7, earnings: 1100, onTimeRate: 92 },
        { driverId: '3', driverName: 'Mike Wilson', completedJobs: 42, avgRating: 4.6, earnings: 1180, onTimeRate: 88 },
        { driverId: '4', driverName: 'Emma Davis', completedJobs: 35, avgRating: 4.9, earnings: 980, onTimeRate: 96 },
        { driverId: '5', driverName: 'David Brown', completedJobs: 40, avgRating: 4.5, earnings: 1050, onTimeRate: 90 },
      ],
      cancellationReasons: [
