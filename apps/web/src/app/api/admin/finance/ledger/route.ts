  ...
  try {
    ...
    if (search) {
      where.OR = [
        ...
        { booking: { customer: { user: { name: { contains: search, mode: 'insensitive' } } } } }
      ];
    }
      ...
      summary: {
        ...
        earningsBreakdown: {
          ...
          netAmount: summary._sum.netAmountPence || 0
                ...
                platformMargin: (revenueBreakdown._sum.totalGBP || 0) - (summary._sum.netAmountPence || 0),
        marginPercentage: revenueBreakdown._sum.totalGBP ?
          (((revenueBreakdown._sum.totalGBP - (summary._sum.netAmountPence || 0)) / revenueBreakdown._sum.totalGBP) * 100).toFixed(2) : '0'
      },
