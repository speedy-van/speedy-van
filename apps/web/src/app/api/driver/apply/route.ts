  ...
  try {
    ...
    const application = await prisma.driverApplication.create({
      data: {
        ...
        nationalInsuranceNumber: 'AB123456C', // Default NI number
        drivingLicenseNumber: '123456789',
        drivingLicenseExpiry: new Date('2030-01-01'),
        insuranceProvider: 'Unknown Insurance',
        ...
        rightToWorkShareCode: 'UNKNOWN123',
        emergencyContactName: 'Unknown Contact',
        emergencyContactPhone: '+447000000000',
