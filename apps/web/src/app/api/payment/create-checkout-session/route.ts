...
export async function POST(request: NextRequest) {
  try {
    ...
    const sessionData = generateMockStripeSession(bookingData, successUrl, cancelUrl);
...
function generateMockStripeSession(bookingData: any, successUrl: string, cancelUrl: string): any {
