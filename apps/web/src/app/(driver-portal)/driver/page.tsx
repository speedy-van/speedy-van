...
import { Box, Grid, GridItem, Heading, Text, Stat, StatLabel, StatNumber, StatHelpText, Badge, VStack, HStack, Card, CardBody, Button, Spacer, Alert, AlertIcon, AlertTitle, AlertDescription, useToast, Spinner, Icon, useColorModeValue } from "@chakra-ui/react";
...
import { FaTruck, FaClock, FaStar, FaShieldAlt, FaMapMarkerAlt, FaCalendarAlt, FaBriefcase, FaPoundSign, FaExclamationTriangle, FaCheckCircle, FaInfoCircle } from "react-icons/fa";
      ...
      <VStack spacing={{ base: 6, md: 8 }} align="stretch">
        ...
        <Box textAlign="center" py={{ base: 4, md: 6 }}>
          <VStack spacing={4}>
            ...
            <Text color="text.secondary" fontSize={{ base: "md", md: "lg" }} maxW="2xl" mx="auto">
              Welcome back, {dashboardData.driver?.name || "Driver"}! Here's your current status and available opportunities.
            </Text>
          </VStack>
        </Box>
            ...
            <CardBody p={{ base: 4, md: 6 }} position="relative" zIndex={1}>
              <VStack spacing={3} align="center">
                ...
                <Stat textAlign="center">
                  <StatLabel fontSize={{ base: "sm", md: "md" }} color="text.secondary" fontWeight="medium">
                    Today's Earnings
                  </StatLabel>
                  <StatNumber fontSize={{ base: "2xl", md: "3xl" }} color="green.500" fontWeight="bold">
                    £{(dashboardData.kpis.todayEarnings || 0).toFixed(2)}
                  </StatNumber>
                  <StatHelpText fontSize={{ base: "xs", md: "sm" }} color="text.tertiary">
            ...
            <CardBody p={{ base: 4, md: 6 }} position="relative" zIndex={1}>
              <VStack spacing={3} align="center">
                ...
                <Stat textAlign="center">
                  ...
                  <StatNumber fontSize={{ base: "2xl", md: "3xl" }} color="blue.500" fontWeight="bold">
            ...
            <CardBody p={{ base: 4, md: 6 }} position="relative" zIndex={1}>
              <VStack spacing={3} align="center">
                ...
                <Stat textAlign="center">
                  ...
                  <StatNumber fontSize={{ base: "2xl", md: "3xl" }} color="yellow.500" fontWeight="bold">
            ...
            <CardBody p={{ base: 4, md: 6 }} position="relative" zIndex={1}>
              <VStack spacing={3} align="center">
                ...
                <Stat textAlign="center">
                  ...
                  <StatNumber fontSize={{ base: "2xl", md: "3xl" }} color={`${getAvailabilityColor(dashboardData.kpis.availability || 'offline')}.500`} fontWeight="bold">
                    <Badge 
                      colorScheme={getAvailabilityColor(dashboardData.kpis.availability || 'offline')} 
                      size={{ base: "md", md: "lg" }}
                      px={3}
                      py={1}
                      borderRadius="full"
                ...
                <VStack align="stretch" spacing={4}>
                  {dashboardData.alerts.map((alert, index) => (
                    <Alert 
                      ...
                      borderRadius="xl"
                      borderWidth="1px"
                      borderColor={alert.type === 'expired' ? 'red.400' : alert.type === 'expiring' ? 'orange.400' : 'blue.400'}
                    >
                      <AlertIcon />
                      <Box flex="1">
                        <AlertTitle fontSize={{ base: "sm", md: "md" }} fontWeight="semibold">
                      ...
                      <Button 
                        size={{ base: "sm", md: "md" }} 
                        colorScheme={alert.type === 'missing' ? 'blue' : 'green'}
                        _hover={{
              ...
              <VStack spacing={6} align="stretch">
                ...
                <VStack align="stretch" spacing={4}>
                  <HStack justify="space-between" flexWrap={{ base: "wrap", md: "nowrap" }}>
                    ...
                    <Badge 
                      colorScheme={dashboardData.locationStatus.hasConsent ? "green" : "gray"} 
                      size="lg"
                      px={4}
                      py={2}
                      borderRadius="full"
                  ...
                  {dashboardData.locationStatus.lastSeen && (
                    <Text fontSize={{ base: "sm", md: "md" }} color="text.tertiary">
              ...
              <VStack spacing={6} align="stretch">
                ...
                <VStack align="stretch" spacing={4}>
                    ...
                    >
                      <HStack justify="space-between" flexWrap={{ base: "wrap", md: "nowrap" }}>
                        <VStack align="start" spacing={2}>
                          <Text fontWeight="bold" fontSize={{ base: "md", md: "lg" }} color="text.primary">
                  ...
                  {dashboardData.shifts && dashboardData.shifts.length > 3 && (
                    <Text fontSize={{ base: "sm", md: "md" }} color="text.tertiary" textAlign="center">
            ...
            <VStack spacing={6} align="stretch">
              ...
              {dashboardData.availableJobs && dashboardData.availableJobs.length > 0 ? (
                        ...
                        <VStack align="stretch" spacing={3}>
                          <HStack spacing={4} align="start">
                            <VStack align="start" spacing={1} flex="1">
                              <Text fontSize={{ base: "sm", md: "md" }} color="text.secondary" fontWeight="medium">
                                <Icon as={FaMapMarkerAlt} mr={2} color="red.400" />
                                Pickup
                              </Text>
                              <Text fontSize={{ base: "sm", md: "md" }} color="text.primary">
                                {job.pickupAddress}
                              </Text>
                            </VStack>
                            <VStack align="start" spacing={1} flex="1">
                              <Text fontSize={{ base: "sm", md: "md" }} color="text.secondary" fontWeight="medium">
                                <Icon as={FaMapMarkerAlt} mr={2} color="green.400" />
                                Dropoff
                              </Text>
                              <Text fontSize={{ base: "sm", md: "md" }} color="text.primary">
                                {job.dropoffAddress}
                          ...
                          <HStack spacing={6} color="text.tertiary" fontSize={{ base: "sm", md: "md" }}>
                            <HStack spacing={2}>
                              <Icon as={FaCalendarAlt} color="neon.400" />
                              <Text>{new Date(job.scheduledAt).toLocaleDateString()}</Text>
                            </HStack>
                            {job.timeSlot && (
                              <HStack spacing={2}>
                ...
                <Box textAlign="center" py={8}>
                  <Icon as={FaInfoCircle} color="text.tertiary" boxSize={12} mb={4} />
                  <Text color="text.secondary" fontSize={{ base: "md", md: "lg" }} mb={2}>
                    No jobs available in your area
                  </Text>
                  <Text color="text.tertiary" fontSize={{ base: "sm", md: "md" }}>
                    Make sure you're online and in a service area to see available jobs.
                  </Text>
                </Box>
              )}
            </VStack>
