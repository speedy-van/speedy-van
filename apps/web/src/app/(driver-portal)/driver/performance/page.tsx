          ...
          <CardBody>
            <Stat>
              ...
              <StatNumber>
                <HStack>
                  <Text fontSize="2xl">
                    {performanceData.performance.averageRating.toFixed(1)}
                  </Text>
                  <HStack spacing={1}>
                    {renderStars(
                      Math.round(performanceData.performance.averageRating)
                    )}
                  </HStack>
                </HStack>
              </StatNumber>
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatNumber>
                {performanceData.performance.completionRate.toFixed(1)}%
              </StatNumber>
              <StatHelpText>
                <Progress
                  ...
                  mb={2}
                />
                {performanceData.performance.completedJobs} of{' '}
                {performanceData.performance.totalJobs} jobs
              </StatHelpText>
            </Stat>
          </CardBody>
        </Card>
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatNumber>
                {performanceData.performance.acceptanceRate.toFixed(1)}%
              </StatNumber>
              <StatHelpText>Jobs accepted vs offered</StatHelpText>
            </Stat>
          </CardBody>
        </Card>
        ...
        <Card>
          <CardBody>
            <Stat>
              ...
              <StatNumber>
                {performanceData.performance.onTimeRate.toFixed(1)}%
              </StatNumber>
              <StatHelpText>Jobs completed on time</StatHelpText>
            </Stat>
          </CardBody>
        </Card>
      </Grid>
        ...
        <CardBody>
          ...
          <Grid templateColumns="repeat(auto-fit, minmax(200px, 1fr))" gap={4}>
            ...
            <Box>
              ...
              <Text fontSize="xl" fontWeight="bold">
                {performanceData.monthly.jobsCompleted} /{' '}
                {performanceData.monthly.totalJobs}
              </Text>
            </Box>
          </Grid>
        </CardBody>
              ...
              <SimpleGrid columns={3} spacing={4} w="full">
                <Checkbox
                  ...
                  onChange={e =>
                    setIncidentForm({
                      ...incidentForm,
                      customerImpact: e.target.checked,
                    })
                  }
                >
                  Customer Impact
                ...
                <Checkbox
                  ...
                  onChange={e =>
                    setIncidentForm({
                      ...incidentForm,
                      injuryInvolved: e.target.checked,
                    })
                  }
                >
                  Injury Involved
