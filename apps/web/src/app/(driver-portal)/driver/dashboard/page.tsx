      ...
      <VStack spacing={6} align="stretch">
        ...
        <Box>
          <Heading size="lg" mb={2}>
            Welcome back, {dashboardData.driver.name || 'Driver'}!
          </Heading>
            ...
            <Card>
              <CardBody>
                <Stat>
                  ...
                  <StatNumber>
                    £
                    {((dashboardData.kpis.todayEarnings || 0) / 100).toFixed(2)}
                  </StatNumber>
                      ...
                      <CardBody>
                        <VStack align="start" spacing={3}>
                          ...
                          <Box>
                            ...
                            <Text>
                              {job.pickupAddress || 'Address not specified'}
                            </Text>
                          </Box>
                          <Box>
                            <Text fontSize="sm" color="gray.600" mb={1}>
                            ...
                            <Text>
                              {job.dropoffAddress || 'Address not specified'}
                            </Text>
                          </Box>
