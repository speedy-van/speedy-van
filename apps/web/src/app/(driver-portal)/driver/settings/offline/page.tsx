...
export default function OfflineSettingsPage() {
  ...
  const saveSettings = (newSettings: typeof settings) => {
    ...
    localStorage.setItem('driver-offline-settings', JSON.stringify(newSettings));
    toast({
  ...
  return (
    <Box p={6} maxW="4xl" mx="auto">
      <VStack spacing={6} align="stretch">
        {/* Header */}
        <Box>
          <Heading size="lg" mb={2}>Offline Settings</Heading>
          <Text color="gray.600">
            Manage how the app behaves when you're offline and configure synchronization preferences.
          </Text>
        </Box>
          ...
          <CardBody>
            <HStack justify="space-between" align="start">
              ...
              <VStack align="end" spacing={2}>
                <Badge colorScheme={state.pendingActions.length > 0 ? 'orange' : 'green'}>
          ...
          <Card>
            <CardBody>
              <VStack align="stretch" spacing={4}>
                ...
                {loading && (
                  <Box>
                    <Text fontSize="sm" mb={2}>Sync Progress</Text>
                    <Progress value={syncProgress} colorScheme="blue" size="sm" />
                  </Box>
                )}
                ...
                <StatGroup>
                  ...
                  <Stat>
                    ...
                    <StatNumber>{actionStats.job_claim + actionStats.job_decline}</StatNumber>
            ...
            <VStack align="stretch" spacing={6}>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => saveSettings({ ...settings, enableBackgroundSync: e.target.checked })}
                />
                <FormHelperText>
                  Allow the app to sync in the background when not actively using it
                </FormHelperText>
              </FormControl>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => saveSettings({ ...settings, cacheJobData: e.target.checked })}
                />
                <FormHelperText>
              ...
              <FormControl>
                ...
                <Switch
                  ...
                  onChange={(e) => saveSettings({ ...settings, cacheLocationData: e.target.checked })}
                />
                <FormHelperText>
              ...
              <FormControl>
                ...
                <HStack>
                  <Button
                    size="sm"
                    onClick={() => saveSettings({ ...settings, maxRetries: Math.max(1, settings.maxRetries - 1) })}
                  >
                    -
                  </Button>
                  ...
                  <Button
                    size="sm"
                    onClick={() => saveSettings({ ...settings, maxRetries: Math.min(10, settings.maxRetries + 1) })}
                  >
                    +
                  </Button>
                </HStack>
              ...
              <FormControl>
                ...
                <HStack>
                  <Button
                    size="sm"
                    onClick={() => saveSettings({ ...settings, syncInterval: Math.max(10, settings.syncInterval - 10) })}
                  >
                    -
                  </Button>
                  ...
                  <Button
                    size="sm"
                    onClick={() => saveSettings({ ...settings, syncInterval: Math.min(300, settings.syncInterval + 10) })}
                  >
                    +
                  </Button>
                </HStack>
                <FormHelperText>
                  How often to attempt syncing when offline (minimum 10s, maximum 5m)
                </FormHelperText>
              </FormControl>
            </VStack>
          </CardBody>
              ...
              <List spacing={3}>
                <ListItem display="flex" alignItems="start">
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      Actions like completing job steps, updating location, and claiming jobs are stored locally and will sync when you're back online.
                    </Text>
                  </Box>
                </ListItem>
                ...
                <ListItem display="flex" alignItems="start">
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      All pending actions are automatically sent to the server in the order they were created.
                    </Text>
                  </Box>
                </ListItem>
                ...
                <ListItem display="flex" alignItems="start">
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      If there are conflicts (e.g., job already claimed by someone else), the system will handle them gracefully and notify you.
                    </Text>
                  </Box>
                </ListItem>
                ...
                <ListItem display="flex" alignItems="start">
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      All offline data is stored securely on your device and is automatically cleaned up after successful sync.
                    </Text>
                  </Box>
                </ListItem>
              </List>
          ...
          <ModalBody>
            <Alert status="warning" mb={4}>
              ...
              <Box>
                ...
                <AlertDescription>
                  This will permanently delete all pending actions that haven't been synchronized yet. 
                  This action cannot be undone.
                </AlertDescription>
              </Box>
            </Alert>
            <Text>
              Are you sure you want to clear {state.pendingActions.length} pending actions?
            </Text>
          </ModalBody>
          <ModalFooter>
            ...
            <Button colorScheme="red" onClick={() => { clearAllActions(); onClose(); }}>
              Clear All Actions
            </Button>
          </ModalFooter>
        </ModalContent>
