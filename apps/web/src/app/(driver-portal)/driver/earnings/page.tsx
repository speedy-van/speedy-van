...
import { FiDollarSign, FiTrendingUp, FiGift, FiSettings, FiPlus } from "react-icons/fi";
...
export default function EarningsPage() {
  ...
  if (loading) {
    return (
      <Box>
        <Heading size="lg" mb={6}>Earnings</Heading>
                ...
                <Stat>
                  ...
                  <StatHelpText>
                    {earningsData.totals.jobs > 0 && 
                      formatCurrency(earningsData.totals.base / earningsData.totals.jobs)
                    } per job
                  </StatHelpText>
                </Stat>
              </CardBody>
            ...
            <Card>
              <CardBody>
                <Stat>
                  ...
                  <StatHelpText>
                    {earningsData.totals.jobs > 0 && 
                      formatCurrency(earningsData.totals.tips / earningsData.totals.jobs)
                    } per job
                  </StatHelpText>
                </Stat>
              </CardBody>
          ...
          <Tabs index={activeTab} onChange={setActiveTab}>
            ...
            <TabPanels>
              ...
              <TabPanel>
                <Card>
                  <CardBody>
                    <Heading size="md" mb={4}>Job Earnings Breakdown</Heading>
                    ...
                    {payoutSettings && (
                      <VStack align="start" spacing={4}>
                        <HStack>
                          ...
                          <Badge colorScheme={payoutSettings.autoPayout ? "green" : "gray"}>
                        ...
                        <HStack>
                          ...
                          <Text>{formatCurrency(payoutSettings.minPayoutAmountPence)}</Text>
                        </HStack>

                        <HStack>
                          <Text fontWeight="bold">Bank Details:</Text>
                          <Badge colorScheme={payoutSettings.hasBankDetails ? "green" : "red"}>
                            {payoutSettings.hasBankDetails ? "Configured" : "Not Set"}
                          </Badge>
                        </HStack>

                        <HStack>
                          <Text fontWeight="bold">Verification:</Text>
                          <Badge colorScheme={payoutSettings.verified ? "green" : "yellow"}>
                        ...
                        {!payoutSettings.hasBankDetails && (
                          <Alert status="warning">
                            <AlertIcon />
                            Please configure your bank details to receive payouts.
                          </Alert>
                        )}
                      </VStack>
                    )}
...
function AddTipModal({ isOpen, onClose, onSuccess }: {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}) {
            ...
            <VStack spacing={4}>
              ...
              <FormControl isRequired>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, totalGBP: e.target.value })}
                  placeholder="0.00"
                />
              </FormControl>
