      ...
      <Box as="header" borderBottom="1px solid" borderColor="gray.100" bg="white" position="sticky" top={0} zIndex={10}>
        <Container maxW="1200px" py={2}>
          <Flex align="center" gap={4}>
            <HStack spacing={6}>
              <ChakraLink as={NextLink} href="/portal" fontWeight="bold" fontSize="lg">
                Speedy Van
              </ChakraLink>
              ...
              <HStack spacing={6}>
                ...
                <ChakraLink as={NextLink} href="/portal/addresses" variant="nav">
                  Addresses & Contacts
                </ChakraLink>
              ...
              <Menu>
                ...
                <MenuList>
                  <Box px={3} py={2}>
                    ...
                    <Text fontSize="sm" color="gray.600">{session.user?.email}</Text>
                  </Box>
                  <MenuDivider />
