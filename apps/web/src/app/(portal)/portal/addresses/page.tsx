  ...
  return (
    <VStack align="stretch" spacing={6}>
      <Box>
        ...
        <Text color="gray.600">
          Manage your saved addresses and contact information
        </Text>
      </Box>
      ...
      <Center py={12}>
        <VStack spacing={4}>
          ...
          <Button colorScheme="blue">Add Your First Address</Button>
        </VStack>
      </Center>
      ...
      <Center py={12}>
        <VStack spacing={4}>
          ...
          <Button colorScheme="blue">Add Your First Contact</Button>
        </VStack>
      </Center>
    </VStack>
  );
