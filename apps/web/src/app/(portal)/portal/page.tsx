...
export default async function PortalDashboard() {
  ...
  return (
    <VStack align="stretch" spacing={6}>
      {/* Welcome Section */}
      <Box>
        <Heading size="lg" mb={2}>Hello, {firstName}!</Heading>
            ...
            <VStack align="stretch" spacing={4}>
              <Box>
                ...
                <Text fontSize="sm" color="gray.600">
                  {nextBooking.scheduledAt ? 
                    ...
                    "Date TBD"
                  } at {nextBooking.scheduledAt ? new Date(nextBooking.scheduledAt).toLocaleTimeString('en-GB', {hour: '2-digit', minute: '2-digit'}) : "Time TBD"}
                </Text>
              </Box>
              ...
              {nextBooking.driver && (
                <Box>
                  ...
                  <Text fontSize="sm" color="gray.600">{nextBooking.driver.user.name}</Text>
                </Box>
              )}
      ...
      <Box>
        <HStack justify="space-between" mb={4}>
          ...
          <Button as={NextLink as any} href="/portal/orders" variant="link" size="sm">
            View All
          </Button>
        </HStack>
        ...
        {recentOrders.length === 0 ? (
          <Box textAlign="center" py={8} borderWidth="1px" borderRadius="md" borderStyle="dashed">
            <Text fontSize="lg" mb={2}>No orders yet</Text>
      ...
      {outstandingPayments.length > 0 && (
        <Box>
          <Heading size="md" mb={4}>Outstanding Actions</Heading>
          <VStack align="stretch" spacing={3}>
      ...
      <Box p={4} bg="blue.50" borderRadius="md">
        <Heading size="sm" mb={2}>📢 Service Updates</Heading>
