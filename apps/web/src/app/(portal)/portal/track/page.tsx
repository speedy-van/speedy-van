  ...
  return (
    <VStack align="stretch" spacing={6}>
      <Box>
        ...
        <Text color="gray.600">
          Track your active Speedy Van deliveries in real-time
        </Text>
      </Box>
        ...
        <Center py={12}>
          <VStack spacing={4}>
            ...
            <Text fontSize="sm" color="gray.500" textAlign="center">
              Once your booking is assigned to a driver, you'll be able to track
              it here.
            </Text>
            <Button
              as={NextLink as any}
              ...
              <CardBody>
                <VStack align="stretch" spacing={4}>
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      {order.pickupAddress?.label || 'Pickup TBD'} →{' '}
                      {order.dropoffAddress?.label || 'Dropoff TBD'}
                    </Text>
                  </Box>
