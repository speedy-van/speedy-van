  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} size="2xl" isCentered>
      ...
      <ModalContent bg={bgColor} borderRadius="xl">
        ...
        <ModalBody>
          <VStack spacing={6} align="stretch">
            ...
            <FormControl isInvalid={!!errors.file}>
                  ...
                  {isDragActive ? (
                    ...
                    <VStack spacing={2}>
                      ...
                      <Text fontSize="sm" color="gray.500">
                        Supported formats: JPEG, PNG, WebP (max {formatFileSize(maxSize)})
                      </Text>
                    </VStack>
                  )}
                </VStack>
              ...
              {selectedFile && (
                <Box mt={3} p={3} bg="green.50" borderRadius="md" border="1px solid" borderColor="green.200">
        ...
        <ModalFooter>
          <HStack spacing={3}>
            <Button variant="outline" onClick={handleClose} isDisabled={isUploading}>
              Cancel
            </Button>
            <Button
              colorScheme="blue"
