  ...
  const getRoleSpecificMenuItems = () => {
    switch (role) {
      case 'customer':
        return (
          <>
            <MenuItem as={NextLink} href="/customer-portal" fontWeight="semibold" color="teal.600">
              📋 My Orders
            </MenuItem>
      ...
      case 'driver':
        return (
          <>
            <MenuItem as={NextLink} href="/driver/dashboard" fontWeight="semibold" color="teal.600">
              🚗 Driver Dashboard
            </MenuItem>
      ...
      case 'admin':
        return (
          <>
            <MenuItem as={NextLink} href="/admin" fontWeight="semibold" color="teal.600">
              🛠️ Admin Dashboard
            </MenuItem>
