'use client';
import { Box, Container, HStack, Button, Heading, IconButton, Drawer, DrawerBody, DrawerHeader, DrawerOverlay, DrawerContent, DrawerCloseButton, VStack, useDisclosure, Text } from "@chakra-ui/react";
  ...
  return (
    <>
      <Box as="header"
        ...
        borderBottom="1px solid" borderColor="border.neon" 
        h={{ base: "60px", md: "64px" }}
      ...
      >
           ...
           <HStack justify="space-between" h="full" spacing={{ base: 1, md: 4 }}>
            ...
            <HStack spacing={3} display={{ base: "flex", md: "none" }} align="center" flexShrink={0}>
                             <HeaderButton 
                 href="/book" 
                 label="Get a quote"
                 size="lg"
       ...
       <Drawer isOpen={isDrawerOpen} placement="right" onClose={onDrawerClose} size="full">
         ...
         />
                   <DrawerContent bg="dark.900" borderLeft="1px solid" borderColor="border.neon" position="relative">
                                 <DrawerHeader 
                ...
                <VStack spacing={3} align="stretch">
                 ...
                 />
                  ...
                  <HeaderButton 
                    ...
                    onClick={onDrawerClose}
                    _hover={{ bg: "rgba(0,194,255,0.1)" }}
                    leftIcon={<Box as="span" fontSize="16px">📞</Box>}
                  />
                </VStack>
