...
import { Box, Heading, Text, Stack, Button, Container, useColorModeValue } from "@chakra-ui/react";
...
const getWeatherPhrases = (city: string, weather: string, temp: number) => {
  ...
  const weatherPhrases = weatherSpecificPhrases[weather as keyof typeof weatherSpecificPhrases] || basePhrases;
...
export default function WeatherHero() {
  ...
  return (
    <Box as="section" position="relative" py={16} textAlign="center" overflow="hidden">
      {/* Video Background */}
      <Box
        position="absolute"
        top="0"
