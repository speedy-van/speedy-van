...
export default function PostPaymentAccountCreation({
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'Welcome to Speedy Van! You can now view all your bookings in your personal portal.',
        status: 'success',
        duration: 5000,
      });
  ...
  const handleSkip = () => {
    toast({
      ...
      description:
        'You can create an account later to view your booking history and manage future bookings.',
      status: 'info',
      duration: 4000,
    });
    onSkip();
        ...
        <CardBody>
          <VStack spacing={6}>
            ...
            <Box textAlign="center" w="full">
              ...
              <Text fontSize="sm" color="gray.600">
                Create an account to view your booking history, track your move,
