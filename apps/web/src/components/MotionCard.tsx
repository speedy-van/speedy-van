...
import { motionVariants, getMotionVariants, createHoverAnimation, createPressAnimation } from '@/lib/motion';
...
export function MotionCard({ 
  ...
  const baseVariants = getMotionVariants(motionVariants[variant === 'fade' ? 'fadeIn' : variant === 'scale' ? 'scaleIn' : 'fadeInUp']);
