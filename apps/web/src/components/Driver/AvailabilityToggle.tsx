...
export default function AvailabilityToggle({ onStatusChange, initialStatus = 'offline' }: AvailabilityToggleProps) {
          ...
          <HStack justify="space-between" align="center" p={4} bg="gray.50" borderRadius="lg">
            <HStack spacing={3}>
              ...
              <VStack align="start" spacing={0}>
                ...
                <Text fontSize="sm" color="gray.600">
                  {isOnline ? 'You can receive job notifications' : 'You will not receive new jobs'}
                </Text>
              </VStack>
            </HStack>
