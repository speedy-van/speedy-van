...
export default function JobTracking({ bookingId, isActive, onLocationUpdate }: JobTrackingProps) {
        ...
        <VStack spacing={4} align="stretch">
          ...
          {!trackingStatus.locationConsent && (
            <Alert status="warning">
              ...
              <VStack align="start" spacing={2}>
                ...
                <Text fontSize="sm">
                  Enable location tracking to provide real-time updates to customers
                </Text>
                <Button
                  size="sm"
                  colorScheme="blue"
          ...
          {trackingStatus.locationConsent && (
            <>
              ...
              <Box>
                <Text fontSize="sm" mb={2}>Route Progress</Text>
