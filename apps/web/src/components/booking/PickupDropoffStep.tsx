...
export default function PickupDropoffStep({
  ...
  const pickupAddressLine1 = useMemo(
    () => bookingData.pickupAddress?.line1 || '',
    [bookingData.pickupAddress?.line1]
  );
  const dropoffAddressLine1 = useMemo(
    () => bookingData.dropoffAddress?.line1 || '',
    [bookingData.dropoffAddress?.line1]
  );
  ...
  const validationData = useMemo(() => {
    const pickupValid = {
      ...
      postcode:
        !!bookingData.pickupAddress?.postcode?.trim() &&
        validateUKPostcode(bookingData.pickupAddress.postcode),
    };
    ...
    const dropoffValid = {
      ...
      postcode:
        !!bookingData.dropoffAddress?.postcode?.trim() &&
        validateUKPostcode(bookingData.dropoffAddress.postcode),
    };
  ...
  const updateDropoffAddress = useCallback(
    (field: string, value: string) => {
      updateBookingData({
        dropoffAddress: {
  ...
  const handlePostcodeChange = useCallback(
    (value: string, type: 'pickup' | 'dropoff') => {
  ...
  const useCurrentLocation = useCallback(
    async (type: 'pickup' | 'dropoff') => {
      ...
      try {
        ...
        let errorMessage =
          'Could not detect your location. Please enter manually or check your browser permissions.';
        ...
        {locationError && (
          <Box
            ...
            _before={{
              ...
              borderRadius: 'xl',
              background:
                'linear-gradient(135deg, rgba(245,101,101,0.1), rgba(245,101,101,0.05))',
              pointerEvents: 'none',
            }}
          >
                ...
                <FormControl isInvalid={!!errors.pickupLine1}>
                  ...
                  >
                    <HStack spacing={2}>
                      ...
                      <Tooltip
                        label="Search by street name, postcode, or city name in any order. Address suggestions will appear as you type."
                        placement="top"
                      >
                  ...
                  >
                    <Text
                      ...
                      fontStyle="italic"
                    >
                      💡 Start typing to see address suggestions • You can
                      search by street name, postcode, or city name in any order
                    </Text>
                    ...
                    <Text
                      ...
                      fontStyle="italic"
                    >
                      💡 Tip: Try searching by postcode first (e.g., "SW1A",
                      "M1", "B1") for faster results
                    </Text>
                  </Box>
                </FormControl>
              ) : (
              ...
              {!dropoffManualMode ? (
                ...
                <FormControl isInvalid={!!errors.dropoffLine1}>
                  ...
                  <Textarea
                    ...
                    onChange={e =>
                      updateDropoffAddress('line1', e.target.value)
                    }
                    size="lg"
                    rows={3}
                    borderWidth="2px"
                ...
                <FormControl isInvalid={!!errors.dropoffCity}>
                  ...
                  <InputGroup>
                    <Input
                      ...
                      onChange={e =>
                        updateDropoffAddress('city', e.target.value)
                      }
                      size="lg"
                      borderWidth="2px"
                      borderColor="border.primary"
