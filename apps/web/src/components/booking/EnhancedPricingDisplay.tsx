              ...
              <CardBody textAlign="center" p={4}>
                ...
                <Text fontSize="lg" fontWeight="semibold">
                  {quote.breakdown.floorsCost > 0
                    ? formatCurrency(quote.breakdown.floorsCost)
                    : 'None'}
                </Text>
              </CardBody>
            </Card>
            ...
            <VStack spacing={4} align="stretch" pt={4}>
              ...
              <VStack spacing={3} align="stretch">
                ...
                <HStack justify="space-between">
                  ...
                  <Text fontWeight="semibold">
                    {formatCurrency(
                      quote.breakdown.distanceBase *
                        quote.breakdown.totalVolumeFactor
                    )}
                  </Text>
                </HStack>
              </VStack>
              ...
              <VStack spacing={3} align="stretch">
                <HStack justify="space-between">
                  ...
                  <Text fontWeight="semibold">
                    {formatCurrency(
                      quote.breakdown.total - quote.breakdown.vat
                    )}
                  </Text>
                </HStack>
          ...
          {getFragileItems().length > 0 && (
            <Alert status="warning">
              ...
              <Box>
                ...
                <AlertDescription>
                  You have {getFragileItems().length} fragile item(s). These
                  will receive special handling.
                </AlertDescription>
              </Box>
            </Alert>
          )}
          ...
          {getItemsRequiringTwoPeople().length > 0 && (
            <Alert status="info">
              ...
              <Box>
                ...
                <AlertDescription>
                  {getItemsRequiringTwoPeople().length} item(s) require two
                  people to move safely. We've automatically suggested
