      ...
      <VStack spacing={{ base: 4, md: 6 }} align="stretch">
        ...
        <Box className="booking-form-section">
          ...
          >
            ...
            <RadioGroup
              value={bookingData.crewSize?.toString() || ''}
              onChange={value => updateCrewSize(parseInt(value))}
            >
                      ...
                      >
                        <VStack align="start" spacing={1}>
                          ...
                          <HStack spacing={2} flexWrap="wrap">
                            ...
                            {getRecommendedCrew() === option.value &&
                              getTotalVolume() > 0 && (
                                <Badge
                                  colorScheme="neon"
                                  size="sm"
        ...
        {getTotalVolume() > 0 && (
          ...
          >
            ...
            <Box>
              <AlertTitle fontSize={{ base: 'sm', md: 'sm' }}>
                Crew Recommendation
              </AlertTitle>
              <AlertDescription fontSize={{ base: 'xs', md: 'sm' }}>
                Based on your {getTotalVolume().toFixed(1)} m³ of items, we
                recommend {getRecommendedCrew()} person
                {getRecommendedCrew() !== 1 ? 's' : ''} for optimal efficiency.
              </AlertDescription>
            </Box>
          </Alert>
        )}
