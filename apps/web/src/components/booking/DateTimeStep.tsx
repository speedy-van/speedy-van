...
import { FaCalendar, FaClock, FaArrowRight, FaArrowLeft, FaExclamationTriangle, FaInfoCircle, FaCalendarAlt, FaCheckCircle } from 'react-icons/fa';
...
export default function DateTimeStep({ 
  ...
  const handleFurtherDateRequest = () => {
    toast({
      ...
      description: 'We\'ll contact you to discuss available dates beyond 30 days.',
      status: 'info',
      duration: 5000,
      isClosable: true,
    });
            ...
            <SimpleGrid columns={{ base: 5, md: 6, lg: 10 }} spacing={3} mb={6}>
              {generateDateCards().map((dateCard) => (
                <Box
                  ...
                  borderWidth="2px"
                  borderRadius="xl"
                  borderColor={bookingData.date === dateCard.value ? 'border.neon' : 'border.primary'}
                  bg={dateCard.isWeekend ? 'dark.600' : (bookingData.date === dateCard.value ? 'dark.800' : 'dark.700')}
                  cursor="pointer"
                ...
                >
                  ...
                  <VStack spacing={1} position="relative" zIndex={1} w="full" flex="1" justify="center">
                    {/* Day of week */}
                    <Text 
                      fontSize="xs" 
                    ...
                    <Text 
                      fontSize="lg" 
                      fontWeight="bold" 
                      color={dateCard.isTomorrow ? "brand.500" : (dateCard.isWeekend ? "neon.400" : "text.primary")}
                      lineHeight="1"
                    >
                      {dateCard.display}
                    </Text>
          ...
          {bookingData.date && (
            ...
            >
              <VStack spacing={4} position="relative" zIndex={1}>
                <Text fontSize="xl" fontWeight="bold" color="neon.500" textShadow="0 0 10px rgba(0,194,255,0.5)">
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
              {TIME_SLOTS.map((slot) => (
                <Box
                  ...
                  borderWidth="2px"
                  borderRadius="xl"
                  borderColor={bookingData.time === slot.value ? 'border.neon' : 'border.primary'}
                  ...
                  <VStack spacing={4} position="relative" zIndex={1}>
                    ...
                    <HStack spacing={4} justify="center">
                      ...
                      <VStack spacing={1} align="center">
                        ...
                        <Text fontSize="md" color="neon.400" fontWeight="medium">
                          {slot.timeRange}
                        </Text>
                      </VStack>
                    </HStack>
                    ...
                    {/* Description */}
                    <Text fontSize="sm" color="text.secondary" textAlign="center" px={2}>
                      {slot.description}
                    </Text>
                    ...
                    <Box 
                      p={3} 
                      bg={bookingData.time === slot.value ? 'dark.600' : 'dark.500'} 
                      borderRadius="lg" 
                      w="full"
                      borderWidth="1px"
                      borderColor={bookingData.time === slot.value ? 'neon.300' : 'border.primary'}
                    >
